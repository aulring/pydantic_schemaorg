...
class GameServer(BaseModel):
    ...
    playersOnline: Optional[Union[List[Union[Any, int, str]], Any, int, str]] = Field(
        default=None,
        description="Number of players on the server.",
    )
    game: Optional[Union[List[Union[Any, str]], Any, str]] = Field(
        default=None,
        description="Video game which is played on this server.",
    )
    serverStatus: Optional[Union[List[Union[Any, str]], Any, str]] = Field(
        default=None,
