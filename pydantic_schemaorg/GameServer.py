...
class GameServer(BaseModel):
    ...
    playersOnline: Optional[Union[List[Union[int, dynamic_creation('Integer'), str]], int, dynamic_creation('Integer'), str]] = Field(
        default=None,
        description="Number of players on the server.",
    )
    game: Optional[Union[List[Union[dynamic_creation('VideoGame'), str]], dynamic_creation('VideoGame'), str]] = Field(
        default=None,
        description="Video game which is played on this server.",
    )
    serverStatus: Optional[Union[List[Union[dynamic_creation('GameServerStatus'), str]], dynamic_creation('GameServerStatus'), str]] = Field(
        default=None,
