...
class LymphaticVessel(BaseModel):
    ...
    originatesFrom: Optional[Union[List[Union[dynamic_creation('Vessel'), str]], dynamic_creation('Vessel'), str]] = Field(
        default=None,
        description="The vasculature the lymphatic structure originates, or afferents, from.",
    )
    runsTo: Optional[Union[List[Union[dynamic_creation('Vessel'), str]], dynamic_creation('Vessel'), str]] = Field(
        default=None,
