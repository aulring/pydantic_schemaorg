...
class EducationalOccupationalCredential(BaseModel):
    ...
    recognizedBy: Optional[Union[List[Union[Any, str]], Any, str]] = Field(
        default=None,
    ...
    validFor: Optional[Union[List[Union[Any, str]], Any, str]] = Field(
        default=None,
        description="The duration of validity of a permit or similar thing.",
    )
    validIn: Optional[Union[List[Union[Any, str]], Any, str]] = Field(
        default=None,
        description="The geographic area where a permit or similar thing is valid.",
    )
    credentialCategory: Union[List[Union[Any, str, AnyUrl]], Any, str, AnyUrl] = Field(
        default=None,
