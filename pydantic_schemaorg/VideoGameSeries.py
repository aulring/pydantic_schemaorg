...
class VideoGameSeries(BaseModel):
    ...
    issn: Optional[Union[List[Union[str, dynamic_creation('Text')]], str, dynamic_creation('Text')]] = Field(
        default=None,
    ...
    containsSeason: Optional[Union[List[Union[dynamic_creation('CreativeWorkSeason'), str]], dynamic_creation('CreativeWorkSeason'), str]] = Field(
        default=None,
    ...
    numberOfSeasons: Optional[Union[List[Union[int, dynamic_creation('Integer'), str]], int, dynamic_creation('Integer'), str]] = Field(
        default=None,
    ...
    season: Optional[Union[List[Union[AnyUrl, dynamic_creation('URL'), dynamic_creation('CreativeWorkSeason'), str]], AnyUrl, dynamic_creation('URL'), dynamic_creation('CreativeWorkSeason'), str]] = Field(
        default=None,
    ...
    episodes: Optional[Union[List[Union[dynamic_creation('Episode'), str]], dynamic_creation('Episode'), str]] = Field(
        default=None,
    ...
    seasons: Optional[Union[List[Union[dynamic_creation('CreativeWorkSeason'), str]], dynamic_creation('CreativeWorkSeason'), str]] = Field(
        default=None,
        description="A season in a media series.",
    )
    ...
    episode: Optional[Union[List[Union[dynamic_creation('Episode'), str]], dynamic_creation('Episode'), str]] = Field(
        default=None,
    ...
    numberOfEpisodes: Optional[Union[List[Union[int, dynamic_creation('Integer'), str]], int, dynamic_creation('Integer'), str]] = Field(
        default=None,
