...
class GovernmentPermit(BaseModel):
    ...
    permitAudience: Optional[Union[List[Union[Any, str]], Any, str]] = Field(
        default=None,
    ...
    validUntil: Optional[Union[List[Union[date, Any, str]], date, Any, str]] = Field(
        default=None,
    ...
    issuedThrough: Optional[Union[List[Union[Any, str]], Any, str]] = Field(
        default=None,
