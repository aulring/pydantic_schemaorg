...
class LodgingReservation(BaseModel):
    ...
    checkoutTime: Optional[Union[List[Union[datetime, dynamic_creation('DateTime'), time, dynamic_creation('Time'), str]], datetime, dynamic_creation('DateTime'), time, dynamic_creation('Time'), str]] = Field(
        default=None,
        description="The latest someone may check out of a lodging establishment.",
    )
    lodgingUnitType: Optional[Union[List[Union[str, dynamic_creation('Text'), dynamic_creation('QualitativeValue')]], str, dynamic_creation('Text'), dynamic_creation('QualitativeValue')]] = Field(
        default=None,
        description="Textual description of the unit type (including suite vs. room, size of bed, etc.).",
    )
    numChildren: Optional[Union[List[Union[int, dynamic_creation('Integer'), dynamic_creation('QuantitativeValue'), str]], int, dynamic_creation('Integer'), dynamic_creation('QuantitativeValue'), str]] = Field(
        default=None,
        description="The number of children staying in the unit.",
    )
    numAdults: Optional[Union[List[Union[int, dynamic_creation('Integer'), dynamic_creation('QuantitativeValue'), str]], int, dynamic_creation('Integer'), dynamic_creation('QuantitativeValue'), str]] = Field(
        default=None,
        description="The number of adults staying in the unit.",
    )
    checkinTime: Optional[Union[List[Union[datetime, dynamic_creation('DateTime'), time, dynamic_creation('Time'), str]], datetime, dynamic_creation('DateTime'), time, dynamic_creation('Time'), str]] = Field(
        default=None,
        description="The earliest someone may check into a lodging establishment.",
    )
    lodgingUnitDescription: Optional[Union[List[Union[str, dynamic_creation('Text')]], str, dynamic_creation('Text')]] = Field(
        default=None,
