...
class EngineSpecification(BaseModel):
    ...
    enginePower: Optional[Union[List[Union[Any, str]], Any, str]] = Field(
        default=None,
    ...
    torque: Optional[Union[List[Union[Any, str]], Any, str]] = Field(
        default=None,
    ...
    engineType: Union[List[Union[Any, str, AnyUrl]], Any, str, AnyUrl] = Field(
        default=None,
    ...
    engineDisplacement: Optional[Union[List[Union[Any, str]], Any, str]] = Field(
        default=None,
