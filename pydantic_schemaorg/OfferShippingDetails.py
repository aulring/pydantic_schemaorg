...
class OfferShippingDetails(BaseModel):
    ...
    shippingSettingsLink: Optional[Union[List[Union[Any, str, AnyUrl]], Any, str, AnyUrl]] = Field(
        default=None,
    ...
    shippingDestination: Optional[Union[List[Union[Any, str]], Any, str]] = Field(
        default=None,
        description="indicates (possibly multiple) shipping destinations. These can be defined in several"
     "ways, e.g. postalCode ranges.",
    )
    shippingLabel: Union[List[Union[Any, str]], Any, str] = Field(
        default=None,
    ...
    doesNotShip: Optional[Union[List[Union[StrictBool, Any, str]], StrictBool, Any, str]] = Field(
        default=None,
