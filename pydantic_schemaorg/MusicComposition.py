...
class MusicComposition(BaseModel):
    ...
    iswcCode: Optional[Union[List[Union[str, dynamic_creation('Text')]], str, dynamic_creation('Text')]] = Field(
        default=None,
        description="The International Standard Musical Work Code for the composition.",
    )
    lyrics: Optional[Union[List[Union[dynamic_creation('CreativeWork'), str]], dynamic_creation('CreativeWork'), str]] = Field(
        default=None,
        description="The words in the song.",
    )
    musicalKey: Optional[Union[List[Union[str, dynamic_creation('Text')]], str, dynamic_creation('Text')]] = Field(
        default=None,
    ...
    recordedAs: Optional[Union[List[Union[dynamic_creation('MusicRecording'), str]], dynamic_creation('MusicRecording'), str]] = Field(
        default=None,
    ...
    musicCompositionForm: Optional[Union[List[Union[str, dynamic_creation('Text')]], str, dynamic_creation('Text')]] = Field(
        default=None,
        description="The type of composition (e.g. overture, sonata, symphony, etc.).",
    )
    firstPerformance: Optional[Union[List[Union[dynamic_creation('Event'), str]], dynamic_creation('Event'), str]] = Field(
        default=None,
        description="The date and place the work was first performed.",
    )
    lyricist: Optional[Union[List[Union[dynamic_creation('Person'), str]], dynamic_creation('Person'), str]] = Field(
        default=None,
