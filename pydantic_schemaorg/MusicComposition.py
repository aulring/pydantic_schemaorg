...
class MusicComposition(BaseModel):
    ...
    iswcCode: Union[List[Union[Any, str]], Any, str] = Field(
        default=None,
        description="The International Standard Musical Work Code for the composition.",
    )
    lyrics: Optional[Union[List[Union[Any, str]], Any, str]] = Field(
        default=None,
        description="The words in the song.",
    )
    musicalKey: Union[List[Union[Any, str]], Any, str] = Field(
        default=None,
        description="The key, mode, or scale this composition uses.",
    )
    includedComposition: Optional[Union[List[Union[Any, str]], Any, str]] = Field(
        default=None,
        description="Smaller compositions included in this work (e.g. a movement in a symphony).",
    )
    recordedAs: Optional[Union[List[Union[Any, str]], Any, str]] = Field(
        default=None,
        description="An audio recording of the work.",
    )
    composer: Optional[Union[List[Union[Any, str]], Any, str]] = Field(
        default=None,
        description="The person or organization who wrote a composition, or who is the composer of a work performed"
     "at some event.",
    )
    musicCompositionForm: Union[List[Union[Any, str]], Any, str] = Field(
        default=None,
        description="The type of composition (e.g. overture, sonata, symphony, etc.).",
    )
    firstPerformance: Optional[Union[List[Union[Any, str]], Any, str]] = Field(
        default=None,
        description="The date and place the work was first performed.",
    )
    lyricist: Optional[Union[List[Union[Any, str]], Any, str]] = Field(
        default=None,
        description="The person who wrote the words.",
    )
    musicArrangement: Optional[Union[List[Union[Any, str]], Any, str]] = Field(
        default=None,
