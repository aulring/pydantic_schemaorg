...
class TrainTrip(BaseModel):
    ...
    arrivalPlatform: Union[List[Union[Any, str]], Any, str] = Field(
        default=None,
        description="The platform where the train arrives.",
    )
    departurePlatform: Union[List[Union[Any, str]], Any, str] = Field(
        default=None,
        description="The platform from which the train departs.",
    )
    arrivalStation: Optional[Union[List[Union[Any, str]], Any, str]] = Field(
        default=None,
        description="The station where the train trip ends.",
    )
    trainName: Union[List[Union[Any, str]], Any, str] = Field(
        default=None,
        description="The name of the train (e.g. The Orient Express).",
    )
    trainNumber: Union[List[Union[Any, str]], Any, str] = Field(
        default=None,
        description="The unique identifier for the train.",
    )
    departureStation: Optional[Union[List[Union[Any, str]], Any, str]] = Field(
        default=None,
