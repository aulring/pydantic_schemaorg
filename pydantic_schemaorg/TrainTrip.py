...
class TrainTrip(BaseModel):
    ...
    arrivalPlatform: Optional[Union[List[Union[str, dynamic_creation('Text')]], str, dynamic_creation('Text')]] = Field(
        default=None,
        description="The platform where the train arrives.",
    )
    departurePlatform: Optional[Union[List[Union[str, dynamic_creation('Text')]], str, dynamic_creation('Text')]] = Field(
        default=None,
        description="The platform from which the train departs.",
    )
    arrivalStation: Optional[Union[List[Union[dynamic_creation('TrainStation'), str]], dynamic_creation('TrainStation'), str]] = Field(
        default=None,
        description="The station where the train trip ends.",
    )
    trainName: Optional[Union[List[Union[str, dynamic_creation('Text')]], str, dynamic_creation('Text')]] = Field(
        default=None,
        description="The name of the train (e.g. The Orient Express).",
    )
    trainNumber: Optional[Union[List[Union[str, dynamic_creation('Text')]], str, dynamic_creation('Text')]] = Field(
        default=None,
        description="The unique identifier for the train.",
    )
    departureStation: Optional[Union[List[Union[dynamic_creation('TrainStation'), str]], dynamic_creation('TrainStation'), str]] = Field(
        default=None,
