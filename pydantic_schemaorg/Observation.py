...
class Observation(BaseModel):
    ...
    observedNode: Optional[Union[List[Union[dynamic_creation('StatisticalPopulation'), str]], dynamic_creation('StatisticalPopulation'), str]] = Field(
        default=None,
        description="The observedNode of an [[Observation]], often a [[StatisticalPopulation]].",
    )
    marginOfError: Optional[Union[List[Union[dynamic_creation('QuantitativeValue'), str]], dynamic_creation('QuantitativeValue'), str]] = Field(
        default=None,
        description="A marginOfError for an [[Observation]].",
    )
    measuredValue: Optional[Union[List[Union[dynamic_creation('DataType'), str]], dynamic_creation('DataType'), str]] = Field(
        default=None,
        description="The measuredValue of an [[Observation]].",
    )
    observationDate: Optional[Union[List[Union[datetime, dynamic_creation('DateTime'), str]], datetime, dynamic_creation('DateTime'), str]] = Field(
        default=None,
        description="The observationDate of an [[Observation]].",
    )
    measuredProperty: Optional[Union[List[Union[dynamic_creation('Property'), str]], dynamic_creation('Property'), str]] = Field(
        default=None,
