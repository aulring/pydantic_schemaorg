...
class Observation(BaseModel):
    ...
    observedNode: Optional[Union[List[Union[Any, str]], Any, str]] = Field(
        default=None,
        description="The observedNode of an [[Observation]], often a [[StatisticalPopulation]].",
    )
    marginOfError: Optional[Union[List[Union[Any, str]], Any, str]] = Field(
        default=None,
        description="A marginOfError for an [[Observation]].",
    )
    measuredValue: Optional[Union[List[Union[Any, str]], Any, str]] = Field(
        default=None,
        description="The measuredValue of an [[Observation]].",
    )
    observationDate: Optional[Union[List[Union[datetime, Any, str]], datetime, Any, str]] = Field(
        default=None,
        description="The observationDate of an [[Observation]].",
    )
    measuredProperty: Optional[Union[List[Union[Any, str]], Any, str]] = Field(
        default=None,
