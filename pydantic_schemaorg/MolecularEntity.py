...
class MolecularEntity(BaseModel):
    ...
    chemicalRole: Optional[Union[List[Union[dynamic_creation('DefinedTerm'), str]], dynamic_creation('DefinedTerm'), str]] = Field(
        default=None,
        description="A role played by the BioChemEntity within a chemical context.",
    )
    smiles: Optional[Union[List[Union[str, dynamic_creation('Text')]], str, dynamic_creation('Text')]] = Field(
        default=None,
    ...
    potentialUse: Optional[Union[List[Union[dynamic_creation('DefinedTerm'), str]], dynamic_creation('DefinedTerm'), str]] = Field(
        default=None,
        description="Intended use of the BioChemEntity by humans.",
    )
    monoisotopicMolecularWeight: Optional[Union[List[Union[str, dynamic_creation('Text'), dynamic_creation('QuantitativeValue')]], str, dynamic_creation('Text'), dynamic_creation('QuantitativeValue')]] = Field(
        default=None,
    ...
    molecularWeight: Optional[Union[List[Union[str, dynamic_creation('Text'), dynamic_creation('QuantitativeValue')]], str, dynamic_creation('Text'), dynamic_creation('QuantitativeValue')]] = Field(
        default=None,
    ...
    inChIKey: Optional[Union[List[Union[str, dynamic_creation('Text')]], str, dynamic_creation('Text')]] = Field(
        default=None,
        description="InChIKey is a hashed version of the full InChI (using the SHA-256 algorithm).",
    )
    iupacName: Optional[Union[List[Union[str, dynamic_creation('Text')]], str, dynamic_creation('Text')]] = Field(
        default=None,
        description="Systematic method of naming chemical compounds as recommended by the International"
     "Union of Pure and Applied Chemistry (IUPAC).",
    )
    molecularFormula: Optional[Union[List[Union[str, dynamic_creation('Text')]], str, dynamic_creation('Text')]] = Field(
        default=None,
        description="The empirical formula is the simplest whole number ratio of all the atoms in a molecule.",
    )
    inChI: Optional[Union[List[Union[str, dynamic_creation('Text')]], str, dynamic_creation('Text')]] = Field(
        default=None,
