...
class MolecularEntity(BaseModel):
    ...
    chemicalRole: Optional[Union[List[Union[Any, str]], Any, str]] = Field(
        default=None,
        description="A role played by the BioChemEntity within a chemical context.",
    )
    smiles: Union[List[Union[Any, str]], Any, str] = Field(
        default=None,
    ...
    potentialUse: Optional[Union[List[Union[Any, str]], Any, str]] = Field(
        default=None,
        description="Intended use of the BioChemEntity by humans.",
    )
    monoisotopicMolecularWeight: Union[List[Union[Any, str]], Any, str] = Field(
        default=None,
    ...
    molecularWeight: Union[List[Union[Any, str]], Any, str] = Field(
        default=None,
