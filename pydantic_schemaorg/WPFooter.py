...
class WPFooter(BaseModel):
    ...
    xpath: Optional[Union[List[Union[str, dynamic_creation('XPathType')]], str, dynamic_creation('XPathType')]] = Field(
        default=None,
    ...
    cssSelector: Optional[Union[List[Union[str, dynamic_creation('CssSelectorType')]], str, dynamic_creation('CssSelectorType')]] = Field(
        default=None,
