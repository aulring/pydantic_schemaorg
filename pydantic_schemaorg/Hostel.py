...
class Hostel(BaseModel):
    ...
    numberOfRooms: Optional[Union[List[Union[Any, StrictInt, StrictFloat, str]], Any, StrictInt, StrictFloat, str]] = Field(
        default=None,
    ...
    availableLanguage: Union[List[Union[Any, str]], Any, str] = Field(
        default=None,
    ...
    petsAllowed: Union[List[Union[StrictBool, Any, str]], StrictBool, Any, str] = Field(
        default=None,
