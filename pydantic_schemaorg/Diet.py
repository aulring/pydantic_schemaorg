...
class Diet(BaseModel):
    ...
    endorsers: Optional[Union[List[Union[Any, str]], Any, str]] = Field(
        default=None,
        description="People or organizations that endorse the plan.",
    )
    dietFeatures: Union[List[Union[Any, str]], Any, str] = Field(
        default=None,
    ...
    physiologicalBenefits: Union[List[Union[Any, str]], Any, str] = Field(
        default=None,
        description="Specific physiologic benefits associated to the plan.",
    )
    expertConsiderations: Union[List[Union[Any, str]], Any, str] = Field(
        default=None,
        description="Medical expert advice related to the plan.",
    )
    risks: Union[List[Union[Any, str]], Any, str] = Field(
        default=None,
