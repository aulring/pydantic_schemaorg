...
class MedicalRiskScore(BaseModel):
    ...
    estimatesRiskOf: Optional[Union[List[Union[dynamic_creation('MedicalEntity'), str]], dynamic_creation('MedicalEntity'), str]] = Field(
        default=None,
        description="The condition, complication, or symptom whose risk is being estimated.",
    )
    includedRiskFactor: Optional[Union[List[Union[dynamic_creation('MedicalRiskFactor'), str]], dynamic_creation('MedicalRiskFactor'), str]] = Field(
        default=None,
        description="A modifiable or non-modifiable risk factor included in the calculation, e.g. age, coexisting"
     "condition.",
    )
    algorithm: Optional[Union[List[Union[str, dynamic_creation('Text')]], str, dynamic_creation('Text')]] = Field(
        default=None,
