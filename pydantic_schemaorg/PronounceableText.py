...
class PronounceableText(BaseModel):
    ...
    textValue: Union[List[Union[Any, str]], Any, str] = Field(
        default=None,
        description="Text value being annotated.",
    )
    phoneticText: Union[List[Union[Any, str]], Any, str] = Field(
        default=None,
    ...
    speechToTextMarkup: Union[List[Union[Any, str]], Any, str] = Field(
        default=None,
