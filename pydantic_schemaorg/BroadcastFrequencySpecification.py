...
class BroadcastFrequencySpecification(BaseModel):
    ...
    broadcastSignalModulation: Optional[Union[List[Union[str, dynamic_creation('Text'), dynamic_creation('QualitativeValue')]], str, dynamic_creation('Text'), dynamic_creation('QualitativeValue')]] = Field(
        default=None,
        description="The modulation (e.g. FM, AM, etc) used by a particular broadcast service.",
    )
    broadcastSubChannel: Optional[Union[List[Union[str, dynamic_creation('Text')]], str, dynamic_creation('Text')]] = Field(
        default=None,
        description="The subchannel used for the broadcast.",
    )
    broadcastFrequencyValue: Optional[Union[List[Union[StrictInt, StrictFloat, dynamic_creation('Number'), dynamic_creation('QuantitativeValue'), str]], StrictInt, StrictFloat, dynamic_creation('Number'), dynamic_creation('QuantitativeValue'), str]] = Field(
        default=None,
