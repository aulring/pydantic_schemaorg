...
class BroadcastFrequencySpecification(BaseModel):
    ...
    broadcastSignalModulation: Union[List[Union[Any, str]], Any, str] = Field(
        default=None,
        description="The modulation (e.g. FM, AM, etc) used by a particular broadcast service.",
    )
    broadcastSubChannel: Union[List[Union[Any, str]], Any, str] = Field(
        default=None,
        description="The subchannel used for the broadcast.",
    )
    broadcastFrequencyValue: Optional[Union[List[Union[Any, StrictInt, StrictFloat, str]], Any, StrictInt, StrictFloat, str]] = Field(
        default=None,
