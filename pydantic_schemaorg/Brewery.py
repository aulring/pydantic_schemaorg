...
class Brewery(BaseModel):
    ...
    starRating: Optional[Union[List[Union[dynamic_creation('Rating'), str]], dynamic_creation('Rating'), str]] = Field(
        default=None,
    ...
    servesCuisine: Optional[Union[List[Union[str, dynamic_creation('Text')]], str, dynamic_creation('Text')]] = Field(
        default=None,
        description="The cuisine of the restaurant.",
    )
    acceptsReservations: Optional[Union[List[Union[AnyUrl, dynamic_creation('URL'), StrictBool, dynamic_creation('Boolean'), str, dynamic_creation('Text')]], AnyUrl, dynamic_creation('URL'), StrictBool, dynamic_creation('Boolean'), str, dynamic_creation('Text')]] = Field(
        default=None,
    ...
    menu: Optional[Union[List[Union[AnyUrl, dynamic_creation('URL'), str, dynamic_creation('Text'), dynamic_creation('Menu')]], AnyUrl, dynamic_creation('URL'), str, dynamic_creation('Text'), dynamic_creation('Menu')]] = Field(
        default=None,
        description="Either the actual menu as a structured representation, as text, or a URL of the menu.",
    )
    hasMenu: Optional[Union[List[Union[AnyUrl, dynamic_creation('URL'), str, dynamic_creation('Text'), dynamic_creation('Menu')]], AnyUrl, dynamic_creation('URL'), str, dynamic_creation('Text'), dynamic_creation('Menu')]] = Field(
        default=None,
        description="Either the actual menu as a structured representation, as text, or a URL of the menu.",
    )
