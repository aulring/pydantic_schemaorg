...
class EntryPoint(BaseModel):
    ...
    encodingType: Union[List[Union[Any, str]], Any, str] = Field(
        default=None,
        description="The supported encoding type(s) for an EntryPoint request.",
    )
    actionApplication: Optional[Union[List[Union[Any, str]], Any, str]] = Field(
        default=None,
        description="An application that can complete the request.",
    )
    actionPlatform: Union[List[Union[Any, str, AnyUrl]], Any, str, AnyUrl] = Field(
        default=None,
    ...
    contentType: Union[List[Union[Any, str]], Any, str] = Field(
        default=None,
        description="The supported content type(s) for an EntryPoint response.",
    )
    application: Optional[Union[List[Union[Any, str]], Any, str]] = Field(
        default=None,
        description="An application that can complete the request.",
    )
    httpMethod: Union[List[Union[Any, str]], Any, str] = Field(
        default=None,
    ...
    urlTemplate: Union[List[Union[Any, str]], Any, str] = Field(
        default=None,
