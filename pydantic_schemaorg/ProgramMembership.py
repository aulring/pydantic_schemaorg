...
class ProgramMembership(BaseModel):
    ...
    hostingOrganization: Optional[Union[List[Union[Any, str]], Any, str]] = Field(
        default=None,
        description="The organization (airline, travelers' club, etc.) the membership is made with.",
    )
    membershipNumber: Union[List[Union[Any, str]], Any, str] = Field(
        default=None,
    ...
    membershipPointsEarned: Optional[Union[List[Union[Any, StrictInt, StrictFloat, str]], Any, StrictInt, StrictFloat, str]] = Field(
        default=None,
    ...
    programName: Union[List[Union[Any, str]], Any, str] = Field(
        default=None,
