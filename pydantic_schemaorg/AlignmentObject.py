...
class AlignmentObject(BaseModel):
    ...
    targetName: Union[List[Union[Any, str]], Any, str] = Field(
        default=None,
        description="The name of a node in an established educational framework.",
    )
    targetUrl: Optional[Union[List[Union[Any, str, AnyUrl]], Any, str, AnyUrl]] = Field(
        default=None,
        description="The URL of a node in an established educational framework.",
    )
    alignmentType: Union[List[Union[Any, str]], Any, str] = Field(
        default=None,
    ...
    targetDescription: Union[List[Union[Any, str]], Any, str] = Field(
        default=None,
        description="The description of a node in an established educational framework.",
    )
    educationalFramework: Union[List[Union[Any, str]], Any, str] = Field(
        default=None,
