...
class GeoCircle(BaseModel):
    ...
    geoMidpoint: Optional[Union[List[Union[dynamic_creation('GeoCoordinates'), str]], dynamic_creation('GeoCoordinates'), str]] = Field(
        default=None,
        description="Indicates the GeoCoordinates at the centre of a GeoShape, e.g. GeoCircle.",
    )
    geoRadius: Optional[Union[List[Union[StrictInt, StrictFloat, dynamic_creation('Number'), str, dynamic_creation('Text'), dynamic_creation('Distance')]], StrictInt, StrictFloat, dynamic_creation('Number'), str, dynamic_creation('Text'), dynamic_creation('Distance')]] = Field(
        default=None,
