...
class GeoCircle(BaseModel):
    ...
    polygon: Union[List[Union[Any, str]], Any, str] = Field(
        default=None,
    ...
    circle: Union[List[Union[Any, str]], Any, str] = Field(
        default=None,
    ...
    elevation: Union[List[Union[Any, StrictInt, StrictFloat, str]], Any, StrictInt, StrictFloat, str] = Field(
        default=None,
    ...
    line: Union[List[Union[Any, str]], Any, str] = Field(
        default=None,
    ...
    box: Union[List[Union[Any, str]], Any, str] = Field(
        default=None,
    ...
    geoMidpoint: Optional[Union[List[Union[Any, str]], Any, str]] = Field(
        default=None,
        description="Indicates the GeoCoordinates at the centre of a GeoShape, e.g. GeoCircle.",
    )
    geoRadius: Union[List[Union[Any, StrictInt, StrictFloat, str]], Any, StrictInt, StrictFloat, str] = Field(
        default=None,
