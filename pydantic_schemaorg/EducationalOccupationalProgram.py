...
class EducationalOccupationalProgram(BaseModel):
    ...
    applicationDeadline: Optional[Union[List[Union[date, Any, str]], date, Any, str]] = Field(
        default=None,
        description="The date at which the program stops collecting applications for the next enrollment"
     "cycle.",
    )
    timeToComplete: Optional[Union[List[Union[Any, str]], Any, str]] = Field(
        default=None,
        description="The expected length of time to complete the program if attending full-time.",
    )
    timeOfDay: Union[List[Union[Any, str]], Any, str] = Field(
        default=None,
    ...
    termsPerYear: Optional[Union[List[Union[Any, StrictInt, StrictFloat, str]], Any, StrictInt, StrictFloat, str]] = Field(
        default=None,
    ...
    termDuration: Optional[Union[List[Union[Any, str]], Any, str]] = Field(
        default=None,
    ...
    financialAidEligible: Union[List[Union[Any, str]], Any, str] = Field(
        default=None,
        description="A financial aid type or program which students may use to pay for tuition or fees associated"
     "with the program.",
    )
    salaryUponCompletion: Optional[Union[List[Union[Any, str]], Any, str]] = Field(
        default=None,
        description="The expected salary upon completing the training.",
    )
    hasCourse: Optional[Union[List[Union[Any, str]], Any, str]] = Field(
        default=None,
    ...
    typicalCreditsPerTerm: Optional[Union[List[Union[Any, int, str]], Any, int, str]] = Field(
        default=None,
    ...
    maximumEnrollment: Optional[Union[List[Union[Any, int, str]], Any, int, str]] = Field(
        default=None,
        description="The maximum number of students who may be enrolled in the program.",
    )
    programType: Union[List[Union[Any, str]], Any, str] = Field(
        default=None,
        description="The type of educational or occupational program. For example, classroom, internship,"
     "alternance, etc.",
    )
    programPrerequisites: Union[List[Union[Any, str]], Any, str] = Field(
        default=None,
        description="Prerequisites for enrolling in the program.",
    )
    educationalProgramMode: Union[List[Union[Any, str, AnyUrl]], Any, str, AnyUrl] = Field(
        default=None,
    ...
    dayOfWeek: Optional[Union[List[Union[Any, str]], Any, str]] = Field(
        default=None,
    ...
    trainingSalary: Optional[Union[List[Union[Any, str]], Any, str]] = Field(
        default=None,
    ...
    applicationStartDate: Optional[Union[List[Union[date, Any, str]], date, Any, str]] = Field(
        default=None,
