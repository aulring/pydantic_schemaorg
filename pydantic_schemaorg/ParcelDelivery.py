...
class ParcelDelivery(BaseModel):
    ...
    itemShipped: Optional[Union[List[Union[Any, str]], Any, str]] = Field(
        default=None,
        description="Item(s) being shipped.",
    )
    trackingNumber: Union[List[Union[Any, str]], Any, str] = Field(
        default=None,
        description="Shipper tracking number.",
    )
    expectedArrivalUntil: Optional[Union[List[Union[datetime, date, Any, str]], datetime, date, Any, str]] = Field(
        default=None,
    ...
    deliveryAddress: Optional[Union[List[Union[Any, str]], Any, str]] = Field(
        default=None,
        description="Destination address.",
    )
    expectedArrivalFrom: Optional[Union[List[Union[datetime, date, Any, str]], datetime, date, Any, str]] = Field(
        default=None,
    ...
    originAddress: Optional[Union[List[Union[Any, str]], Any, str]] = Field(
        default=None,
        description="Shipper's address.",
    )
    deliveryStatus: Optional[Union[List[Union[Any, str]], Any, str]] = Field(
        default=None,
        description="New entry added as the package passes through each leg of its journey (from shipment to"
     "final delivery).",
    )
    trackingUrl: Optional[Union[List[Union[Any, str, AnyUrl]], Any, str, AnyUrl]] = Field(
        default=None,
        description="Tracking url for the parcel delivery.",
    )
    partOfOrder: Optional[Union[List[Union[Any, str]], Any, str]] = Field(
        default=None,
