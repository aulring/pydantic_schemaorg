...
class BoatTrip(BaseModel):
    ...
    departureBoatTerminal: Optional[Union[List[Union[dynamic_creation('BoatTerminal'), str]], dynamic_creation('BoatTerminal'), str]] = Field(
        default=None,
        description="The terminal or port from which the boat departs.",
    )
    arrivalBoatTerminal: Optional[Union[List[Union[dynamic_creation('BoatTerminal'), str]], dynamic_creation('BoatTerminal'), str]] = Field(
        default=None,
