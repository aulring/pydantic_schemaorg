...
class MonetaryGrant(BaseModel):
    ...
    fundedItem: Optional[Union[List[Union[dynamic_creation('MedicalEntity'), dynamic_creation('CreativeWork'), dynamic_creation('BioChemEntity'), dynamic_creation('Product'), dynamic_creation('Event'), dynamic_creation('Person'), dynamic_creation('Organization'), str]], dynamic_creation('MedicalEntity'), dynamic_creation('CreativeWork'), dynamic_creation('BioChemEntity'), dynamic_creation('Product'), dynamic_creation('Event'), dynamic_creation('Person'), dynamic_creation('Organization'), str]] = Field(
        default=None,
