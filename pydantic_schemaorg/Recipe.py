...
class Recipe(BaseModel):
    ...
    prepTime: Optional[Union[List[Union[dynamic_creation('Duration'), str]], dynamic_creation('Duration'), str]] = Field(
        default=None,
    ...
    steps: Optional[Union[List[Union[str, dynamic_creation('Text'), dynamic_creation('ItemList'), dynamic_creation('CreativeWork')]], str, dynamic_creation('Text'), dynamic_creation('ItemList'), dynamic_creation('CreativeWork')]] = Field(
        default=None,
    ...
    yield_: Optional[Union[List[Union[str, dynamic_creation('Text'), dynamic_creation('QuantitativeValue')]], str, dynamic_creation('Text'), dynamic_creation('QuantitativeValue')]] = Field(
    ...
    tool: Optional[Union[List[Union[str, dynamic_creation('Text'), dynamic_creation('HowToTool')]], str, dynamic_creation('Text'), dynamic_creation('HowToTool')]] = Field(
        default=None,
        description="A sub property of instrument. An object used (but not consumed) when performing instructions"
     "or a direction.",
    )
    step: Optional[Union[List[Union[str, dynamic_creation('Text'), dynamic_creation('CreativeWork'), dynamic_creation('HowToStep'), dynamic_creation('HowToSection')]], str, dynamic_creation('Text'), dynamic_creation('CreativeWork'), dynamic_creation('HowToStep'), dynamic_creation('HowToSection')]] = Field(
        default=None,
        description="A single step item (as HowToStep, text, document, video, etc.) or a HowToSection.",
    )
    performTime: Optional[Union[List[Union[dynamic_creation('Duration'), str]], dynamic_creation('Duration'), str]] = Field(
        default=None,
    ...
    supply: Optional[Union[List[Union[str, dynamic_creation('Text'), dynamic_creation('HowToSupply')]], str, dynamic_creation('Text'), dynamic_creation('HowToSupply')]] = Field(
        default=None,
        description="A sub-property of instrument. A supply consumed when performing instructions or a direction.",
    )
    totalTime: Optional[Union[List[Union[dynamic_creation('Duration'), str]], dynamic_creation('Duration'), str]] = Field(
        default=None,
    ...
    recipeYield: Optional[Union[List[Union[str, dynamic_creation('Text'), dynamic_creation('QuantitativeValue')]], str, dynamic_creation('Text'), dynamic_creation('QuantitativeValue')]] = Field(
        default=None,
        description="The quantity produced by the recipe (for example, number of people served, number of"
     "servings, etc).",
    )
    nutrition: Optional[Union[List[Union[dynamic_creation('NutritionInformation'), str]], dynamic_creation('NutritionInformation'), str]] = Field(
        default=None,
        description="Nutrition information about the recipe or menu item.",
    )
    cookingMethod: Optional[Union[List[Union[str, dynamic_creation('Text')]], str, dynamic_creation('Text')]] = Field(
        default=None,
        description="The method of cooking, such as Frying, Steaming, ...",
    )
    suitableForDiet: Optional[Union[List[Union[dynamic_creation('RestrictedDiet'), str]], dynamic_creation('RestrictedDiet'), str]] = Field(
        default=None,
    ...
    cookTime: Optional[Union[List[Union[dynamic_creation('Duration'), str]], dynamic_creation('Duration'), str]] = Field(
        default=None,
        description="The time it takes to actually cook the dish, in [ISO 8601 duration format](http://en.wikipedia.org/wiki/ISO_8601).",
    )
    ingredients: Optional[Union[List[Union[str, dynamic_creation('Text')]], str, dynamic_creation('Text')]] = Field(
        default=None,
        description="A single ingredient used in the recipe, e.g. sugar, flour or garlic.",
    )
    recipeCuisine: Optional[Union[List[Union[str, dynamic_creation('Text')]], str, dynamic_creation('Text')]] = Field(
        default=None,
        description="The cuisine of the recipe (for example, French or Ethiopian).",
    )
    recipeInstructions: Optional[Union[List[Union[str, dynamic_creation('Text'), dynamic_creation('ItemList'), dynamic_creation('CreativeWork')]], str, dynamic_creation('Text'), dynamic_creation('ItemList'), dynamic_creation('CreativeWork')]] = Field(
        default=None,
    ...
    recipeIngredient: Optional[Union[List[Union[str, dynamic_creation('Text')]], str, dynamic_creation('Text')]] = Field(
        default=None,
        description="A single ingredient used in the recipe, e.g. sugar, flour or garlic.",
    )
    recipeCategory: Optional[Union[List[Union[str, dynamic_creation('Text')]], str, dynamic_creation('Text')]] = Field(
        default=None,
