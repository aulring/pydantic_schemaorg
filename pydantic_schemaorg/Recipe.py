...
class Recipe(BaseModel):
    ...
    prepTime: Optional[Union[List[Union[Any, str]], Any, str]] = Field(
        default=None,
    ...
    steps: Union[List[Union[Any, str]], Any, str] = Field(
        default=None,
    ...
    estimatedCost: Union[List[Union[Any, str]], Any, str] = Field(
        default=None,
        description="The estimated cost of the supply or supplies consumed when performing instructions.",
    )
    yield_: Union[List[Union[Any, str]], Any, str] = Field(
    ...
    supply: Union[List[Union[Any, str]], Any, str] = Field(
        default=None,
        description="A sub-property of instrument. A supply consumed when performing instructions or a direction.",
    )
    totalTime: Optional[Union[List[Union[Any, str]], Any, str]] = Field(
        default=None,
    ...
    recipeYield: Union[List[Union[Any, str]], Any, str] = Field(
        default=None,
        description="The quantity produced by the recipe (for example, number of people served, number of"
     "servings, etc).",
    )
    nutrition: Optional[Union[List[Union[Any, str]], Any, str]] = Field(
        default=None,
        description="Nutrition information about the recipe or menu item.",
    )
    cookingMethod: Union[List[Union[Any, str]], Any, str] = Field(
        default=None,
        description="The method of cooking, such as Frying, Steaming, ...",
    )
    suitableForDiet: Optional[Union[List[Union[Any, str]], Any, str]] = Field(
        default=None,
    ...
    recipeIngredient: Union[List[Union[Any, str]], Any, str] = Field(
        default=None,
        description="A single ingredient used in the recipe, e.g. sugar, flour or garlic.",
    )
    recipeCategory: Union[List[Union[Any, str]], Any, str] = Field(
        default=None,
