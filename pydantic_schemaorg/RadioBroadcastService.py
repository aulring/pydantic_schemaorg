...
class RadioBroadcastService(BaseModel):
    ...
    hasBroadcastChannel: Optional[Union[List[Union[dynamic_creation('BroadcastChannel'), str]], dynamic_creation('BroadcastChannel'), str]] = Field(
        default=None,
    ...
    broadcastAffiliateOf: Optional[Union[List[Union[dynamic_creation('Organization'), str]], dynamic_creation('Organization'), str]] = Field(
        default=None,
        description="The media network(s) whose content is broadcast on this station.",
    )
    broadcaster: Optional[Union[List[Union[dynamic_creation('Organization'), str]], dynamic_creation('Organization'), str]] = Field(
        default=None,
    ...
    broadcastTimezone: Optional[Union[List[Union[str, dynamic_creation('Text')]], str, dynamic_creation('Text')]] = Field(
        default=None,
    ...
    broadcastDisplayName: Optional[Union[List[Union[str, dynamic_creation('Text')]], str, dynamic_creation('Text')]] = Field(
        default=None,
    ...
    area: Optional[Union[List[Union[dynamic_creation('Place'), str]], dynamic_creation('Place'), str]] = Field(
        default=None,
