...
class EnergyConsumptionDetails(BaseModel):
    ...
    hasEnergyEfficiencyCategory: Optional[Union[List[Union[Any, str]], Any, str]] = Field(
        default=None,
    ...
    energyEfficiencyScaleMin: Optional[Union[List[Union[Any, str]], Any, str]] = Field(
        default=None,
    ...
    energyEfficiencyScaleMax: Optional[Union[List[Union[Any, str]], Any, str]] = Field(
        default=None,
