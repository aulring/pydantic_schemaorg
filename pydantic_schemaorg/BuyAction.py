...
class BuyAction(BaseModel):
    ...
    warrantyPromise: Optional[Union[List[Union[dynamic_creation('WarrantyPromise'), str]], dynamic_creation('WarrantyPromise'), str]] = Field(
        default=None,
        description="The warranty promise(s) included in the offer.",
    )
    vendor: Optional[Union[List[Union[dynamic_creation('Organization'), dynamic_creation('Person'), str]], dynamic_creation('Organization'), dynamic_creation('Person'), str]] = Field(
        default=None,
