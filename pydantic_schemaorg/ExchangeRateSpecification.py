...
class ExchangeRateSpecification(BaseModel):
    ...
    currentExchangeRate: Optional[Union[List[Union[Any, str]], Any, str]] = Field(
        default=None,
        description="The current price of a currency.",
    )
    exchangeRateSpread: Optional[Union[List[Union[Any, StrictInt, StrictFloat, str]], Any, StrictInt, StrictFloat, str]] = Field(
        default=None,
