...
class ExchangeRateSpecification(BaseModel):
    ...
    currentExchangeRate: Optional[Union[List[Union[dynamic_creation('UnitPriceSpecification'), str]], dynamic_creation('UnitPriceSpecification'), str]] = Field(
        default=None,
        description="The current price of a currency.",
    )
    exchangeRateSpread: Optional[Union[List[Union[StrictInt, StrictFloat, dynamic_creation('Number'), dynamic_creation('MonetaryAmount'), str]], StrictInt, StrictFloat, dynamic_creation('Number'), dynamic_creation('MonetaryAmount'), str]] = Field(
        default=None,
