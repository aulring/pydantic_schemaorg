...
class LocationFeatureSpecification(BaseModel):
    ...
    value: Union[List[Union[StrictBool, Any, StrictInt, StrictFloat, str]], StrictBool, Any, StrictInt, StrictFloat, str] = Field(
        default=None,
    ...
    valueReference: Union[List[Union[Any, str]], Any, str] = Field(
        default=None,
    ...
    propertyID: Union[List[Union[Any, str, AnyUrl]], Any, str, AnyUrl] = Field(
        default=None,
