...
class CookAction(BaseModel):
    ...
    foodEvent: Optional[Union[List[Union[dynamic_creation('FoodEvent'), str]], dynamic_creation('FoodEvent'), str]] = Field(
        default=None,
        description="A sub property of location. The specific food event where the action occurred.",
    )
    recipe: Optional[Union[List[Union[dynamic_creation('Recipe'), str]], dynamic_creation('Recipe'), str]] = Field(
        default=None,
        description="A sub property of instrument. The recipe/instructions used to perform the action.",
    )
    foodEstablishment: Optional[Union[List[Union[dynamic_creation('Place'), dynamic_creation('FoodEstablishment'), str]], dynamic_creation('Place'), dynamic_creation('FoodEstablishment'), str]] = Field(
        default=None,
