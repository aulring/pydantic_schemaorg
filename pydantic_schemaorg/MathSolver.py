...
class MathSolver(BaseModel):
    ...
    mathExpression: Optional[Union[List[Union[str, dynamic_creation('Text'), dynamic_creation('SolveMathAction')]], str, dynamic_creation('Text'), dynamic_creation('SolveMathAction')]] = Field(
        default=None,
