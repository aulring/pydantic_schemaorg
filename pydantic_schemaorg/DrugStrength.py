...
class DrugStrength(BaseModel):
    ...
    availableIn: Optional[Union[List[Union[dynamic_creation('AdministrativeArea'), str]], dynamic_creation('AdministrativeArea'), str]] = Field(
        default=None,
        description="The location in which the strength is available.",
    )
    strengthValue: Optional[Union[List[Union[StrictInt, StrictFloat, dynamic_creation('Number'), str]], StrictInt, StrictFloat, dynamic_creation('Number'), str]] = Field(
        default=None,
        description="The value of an active ingredient's strength, e.g. 325.",
    )
    strengthUnit: Optional[Union[List[Union[str, dynamic_creation('Text')]], str, dynamic_creation('Text')]] = Field(
        default=None,
