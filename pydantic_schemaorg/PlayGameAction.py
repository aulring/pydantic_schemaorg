...
class PlayGameAction(BaseModel):
    ...
    gameAvailabilityType: Optional[Union[List[Union[str, dynamic_creation('Text'), dynamic_creation('GameAvailabilityEnumeration')]], str, dynamic_creation('Text'), dynamic_creation('GameAvailabilityEnumeration')]] = Field(
        default=None,
