...
class SpecialAnnouncement(BaseModel):
    ...
    diseaseSpreadStatistics: Optional[Union[List[Union[AnyUrl, dynamic_creation('URL'), dynamic_creation('Observation'), dynamic_creation('Dataset'), dynamic_creation('WebContent'), str]], AnyUrl, dynamic_creation('URL'), dynamic_creation('Observation'), dynamic_creation('Dataset'), dynamic_creation('WebContent'), str]] = Field(
        default=None,
    ...
    publicTransportClosuresInfo: Optional[Union[List[Union[AnyUrl, dynamic_creation('URL'), dynamic_creation('WebContent'), str]], AnyUrl, dynamic_creation('URL'), dynamic_creation('WebContent'), str]] = Field(
        default=None,
        description="Information about public transport closures.",
    )
    governmentBenefitsInfo: Optional[Union[List[Union[dynamic_creation('GovernmentService'), str]], dynamic_creation('GovernmentService'), str]] = Field(
        default=None,
        description="governmentBenefitsInfo provides information about government benefits associated"
     "with a SpecialAnnouncement.",
    )
    quarantineGuidelines: Optional[Union[List[Union[AnyUrl, dynamic_creation('URL'), dynamic_creation('WebContent'), str]], AnyUrl, dynamic_creation('URL'), dynamic_creation('WebContent'), str]] = Field(
        default=None,
        description="Guidelines about quarantine rules, e.g. in the context of a pandemic.",
    )
    travelBans: Optional[Union[List[Union[AnyUrl, dynamic_creation('URL'), dynamic_creation('WebContent'), str]], AnyUrl, dynamic_creation('URL'), dynamic_creation('WebContent'), str]] = Field(
        default=None,
        description="Information about travel bans, e.g. in the context of a pandemic.",
    )
    webFeed: Optional[Union[List[Union[AnyUrl, dynamic_creation('URL'), dynamic_creation('DataFeed'), str]], AnyUrl, dynamic_creation('URL'), dynamic_creation('DataFeed'), str]] = Field(
        default=None,
    ...
    diseasePreventionInfo: Optional[Union[List[Union[AnyUrl, dynamic_creation('URL'), dynamic_creation('WebContent'), str]], AnyUrl, dynamic_creation('URL'), dynamic_creation('WebContent'), str]] = Field(
        default=None,
    ...
    announcementLocation: Optional[Union[List[Union[dynamic_creation('LocalBusiness'), dynamic_creation('CivicStructure'), str]], dynamic_creation('LocalBusiness'), dynamic_creation('CivicStructure'), str]] = Field(
        default=None,
    ...
    schoolClosuresInfo: Optional[Union[List[Union[AnyUrl, dynamic_creation('URL'), dynamic_creation('WebContent'), str]], AnyUrl, dynamic_creation('URL'), dynamic_creation('WebContent'), str]] = Field(
        default=None,
        description="Information about school closures.",
    )
    newsUpdatesAndGuidelines: Optional[Union[List[Union[AnyUrl, dynamic_creation('URL'), dynamic_creation('WebContent'), str]], AnyUrl, dynamic_creation('URL'), dynamic_creation('WebContent'), str]] = Field(
        default=None,
    ...
    gettingTestedInfo: Optional[Union[List[Union[AnyUrl, dynamic_creation('URL'), dynamic_creation('WebContent'), str]], AnyUrl, dynamic_creation('URL'), dynamic_creation('WebContent'), str]] = Field(
        default=None,
