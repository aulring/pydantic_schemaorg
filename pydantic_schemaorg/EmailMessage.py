...
class EmailMessage(BaseModel):
    ...
    dateReceived: Optional[Union[List[Union[datetime, dynamic_creation('DateTime'), str]], datetime, dynamic_creation('DateTime'), str]] = Field(
        default=None,
        description="The date/time the message was received if a single recipient exists.",
    )
    recipient: Optional[Union[List[Union[dynamic_creation('ContactPoint'), dynamic_creation('Organization'), dynamic_creation('Audience'), dynamic_creation('Person'), str]], dynamic_creation('ContactPoint'), dynamic_creation('Organization'), dynamic_creation('Audience'), dynamic_creation('Person'), str]] = Field(
        default=None,
        description="A sub property of participant. The participant who is at the receiving end of the action.",
    )
    messageAttachment: Optional[Union[List[Union[dynamic_creation('CreativeWork'), str]], dynamic_creation('CreativeWork'), str]] = Field(
        default=None,
        description="A CreativeWork attached to the message.",
    )
    ccRecipient: Optional[Union[List[Union[dynamic_creation('ContactPoint'), dynamic_creation('Organization'), dynamic_creation('Person'), str]], dynamic_creation('ContactPoint'), dynamic_creation('Organization'), dynamic_creation('Person'), str]] = Field(
        default=None,
        description="A sub property of recipient. The recipient copied on a message.",
    )
    bccRecipient: Optional[Union[List[Union[dynamic_creation('ContactPoint'), dynamic_creation('Organization'), dynamic_creation('Person'), str]], dynamic_creation('ContactPoint'), dynamic_creation('Organization'), dynamic_creation('Person'), str]] = Field(
        default=None,
        description="A sub property of recipient. The recipient blind copied on a message.",
    )
    dateRead: Optional[Union[List[Union[datetime, dynamic_creation('DateTime'), date, dynamic_creation('Date'), str]], datetime, dynamic_creation('DateTime'), date, dynamic_creation('Date'), str]] = Field(
        default=None,
        description="The date/time at which the message has been read by the recipient if a single recipient"
     "exists.",
    )
    dateSent: Optional[Union[List[Union[datetime, dynamic_creation('DateTime'), str]], datetime, dynamic_creation('DateTime'), str]] = Field(
        default=None,
        description="The date/time at which the message was sent.",
    )
    sender: Optional[Union[List[Union[dynamic_creation('Organization'), dynamic_creation('Audience'), dynamic_creation('Person'), str]], dynamic_creation('Organization'), dynamic_creation('Audience'), dynamic_creation('Person'), str]] = Field(
        default=None,
        description="A sub property of participant. The participant who is at the sending end of the action.",
    )
    toRecipient: Optional[Union[List[Union[dynamic_creation('ContactPoint'), dynamic_creation('Organization'), dynamic_creation('Audience'), dynamic_creation('Person'), str]], dynamic_creation('ContactPoint'), dynamic_creation('Organization'), dynamic_creation('Audience'), dynamic_creation('Person'), str]] = Field(
        default=None,
