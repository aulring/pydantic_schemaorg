...
class Hospital(BaseModel):
    ...
    healthPlanNetworkId: Optional[Union[List[Union[str, dynamic_creation('Text')]], str, dynamic_creation('Text')]] = Field(
        default=None,
        description="Name or unique ID of network. (Networks are often reused across different insurance"
     "plans.)",
    )
    medicalSpecialty: Optional[Union[List[Union[dynamic_creation('MedicalSpecialty'), str]], dynamic_creation('MedicalSpecialty'), str]] = Field(
        default=None,
        description="A medical specialty of the provider.",
    )
    isAcceptingNewPatients: Optional[Union[List[Union[StrictBool, dynamic_creation('Boolean'), str]], StrictBool, dynamic_creation('Boolean'), str]] = Field(
        default=None,
    ...
    healthcareReportingData: Optional[Union[List[Union[dynamic_creation('Dataset'), dynamic_creation('CDCPMDRecord'), str]], dynamic_creation('Dataset'), dynamic_creation('CDCPMDRecord'), str]] = Field(
        default=None,
    ...
    availableService: Optional[Union[List[Union[dynamic_creation('MedicalTherapy'), dynamic_creation('MedicalProcedure'), dynamic_creation('MedicalTest'), str]], dynamic_creation('MedicalTherapy'), dynamic_creation('MedicalProcedure'), dynamic_creation('MedicalTest'), str]] = Field(
        default=None,
