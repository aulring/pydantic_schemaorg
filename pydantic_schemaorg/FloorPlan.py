...
class FloorPlan(BaseModel):
    ...
    layoutImage: Optional[Union[List[Union[AnyUrl, dynamic_creation('URL'), dynamic_creation('ImageObject'), str]], AnyUrl, dynamic_creation('URL'), dynamic_creation('ImageObject'), str]] = Field(
        default=None,
    ...
    numberOfAvailableAccommodationUnits: Optional[Union[List[Union[dynamic_creation('QuantitativeValue'), str]], dynamic_creation('QuantitativeValue'), str]] = Field(
        default=None,
    ...
    numberOfAccommodationUnits: Optional[Union[List[Union[dynamic_creation('QuantitativeValue'), str]], dynamic_creation('QuantitativeValue'), str]] = Field(
        default=None,
    ...
    isPlanForApartment: Optional[Union[List[Union[dynamic_creation('Accommodation'), str]], dynamic_creation('Accommodation'), str]] = Field(
        default=None,
