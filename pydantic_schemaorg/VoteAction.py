...
class VoteAction(BaseModel):
    ...
    option: Optional[Union[List[Union[str, dynamic_creation('Text'), dynamic_creation('Thing')]], str, dynamic_creation('Text'), dynamic_creation('Thing')]] = Field(
        default=None,
        description="A sub property of object. The options subject to this action.",
    )
    actionOption: Optional[Union[List[Union[str, dynamic_creation('Text'), dynamic_creation('Thing')]], str, dynamic_creation('Text'), dynamic_creation('Thing')]] = Field(
        default=None,
        description="A sub property of object. The options subject to this action.",
    )
    candidate: Optional[Union[List[Union[dynamic_creation('Person'), str]], dynamic_creation('Person'), str]] = Field(
        default=None,
