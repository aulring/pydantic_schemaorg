...
class Blog(BaseModel):
    ...
    blogPosts: Optional[Union[List[Union[dynamic_creation('BlogPosting'), str]], dynamic_creation('BlogPosting'), str]] = Field(
        default=None,
    ...
    blogPost: Optional[Union[List[Union[dynamic_creation('BlogPosting'), str]], dynamic_creation('BlogPosting'), str]] = Field(
        default=None,
