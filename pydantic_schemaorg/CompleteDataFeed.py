...
class CompleteDataFeed(BaseModel):
    ...
    catalog: Optional[Union[List[Union[dynamic_creation('DataCatalog'), str]], dynamic_creation('DataCatalog'), str]] = Field(
        default=None,
        description="A data catalog which contains this dataset.",
    )
    datasetTimeInterval: Optional[Union[List[Union[datetime, dynamic_creation('DateTime'), str]], datetime, dynamic_creation('DateTime'), str]] = Field(
        default=None,
    ...
    variableMeasured: Optional[Union[List[Union[str, dynamic_creation('Text'), dynamic_creation('PropertyValue')]], str, dynamic_creation('Text'), dynamic_creation('PropertyValue')]] = Field(
        default=None,
    ...
    includedDataCatalog: Optional[Union[List[Union[dynamic_creation('DataCatalog'), str]], dynamic_creation('DataCatalog'), str]] = Field(
        default=None,
    ...
    distribution: Optional[Union[List[Union[dynamic_creation('DataDownload'), str]], dynamic_creation('DataDownload'), str]] = Field(
        default=None,
    ...
    includedInDataCatalog: Optional[Union[List[Union[dynamic_creation('DataCatalog'), str]], dynamic_creation('DataCatalog'), str]] = Field(
        default=None,
        description="A data catalog which contains this dataset.",
    )
    ...
    dataFeedElement: Optional[Union[List[Union[str, dynamic_creation('Text'), dynamic_creation('DataFeedItem'), dynamic_creation('Thing')]], str, dynamic_creation('Text'), dynamic_creation('DataFeedItem'), dynamic_creation('Thing')]] = Field(
        default=None,
