...
class MediaReview(BaseModel):
    ...
    reviewBody: Optional[Union[List[Union[str, dynamic_creation('Text')]], str, dynamic_creation('Text')]] = Field(
        default=None,
    ...
    reviewRating: Optional[Union[List[Union[dynamic_creation('Rating'), str]], dynamic_creation('Rating'), str]] = Field(
        default=None,
    ...
    originalMediaLink: Optional[Union[List[Union[AnyUrl, dynamic_creation('URL'), dynamic_creation('MediaObject'), dynamic_creation('WebPage'), str]], AnyUrl, dynamic_creation('URL'), dynamic_creation('MediaObject'), dynamic_creation('WebPage'), str]] = Field(
        default=None,
    ...
    originalMediaContextDescription: Optional[Union[List[Union[str, dynamic_creation('Text')]], str, dynamic_creation('Text')]] = Field(
        default=None,
    ...
    mediaAuthenticityCategory: Optional[Union[List[Union[dynamic_creation('MediaManipulationRatingEnumeration'), str]], dynamic_creation('MediaManipulationRatingEnumeration'), str]] = Field(
        default=None,
