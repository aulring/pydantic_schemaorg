...
class MediaReview(BaseModel):
    ...
    originalMediaLink: Optional[Union[List[Union[Any, str, AnyUrl]], Any, str, AnyUrl]] = Field(
        default=None,
    ...
    originalMediaContextDescription: Union[List[Union[Any, str]], Any, str] = Field(
        default=None,
    ...
    mediaAuthenticityCategory: Optional[Union[List[Union[Any, str]], Any, str]] = Field(
        default=None,
