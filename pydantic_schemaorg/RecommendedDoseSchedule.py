...
class RecommendedDoseSchedule(BaseModel):
    ...
    targetPopulation: Union[List[Union[Any, str]], Any, str] = Field(
        default=None,
        description="Characteristics of the population for which this is intended, or which typically uses"
     "it, e.g. 'adults'.",
    )
    doseValue: Optional[Union[List[Union[Any, StrictInt, StrictFloat, str]], Any, StrictInt, StrictFloat, str]] = Field(
        default=None,
        description="The value of the dose, e.g. 500.",
    )
    doseUnit: Union[List[Union[Any, str]], Any, str] = Field(
        default=None,
        description="The unit of the dose, e.g. 'mg'.",
    )
    frequency: Union[List[Union[Any, str]], Any, str] = Field(
        default=None,
