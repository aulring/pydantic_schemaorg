...
class ShippingDeliveryTime(BaseModel):
    ...
    cutoffTime: Optional[Union[List[Union[Any, time, str]], Any, time, str]] = Field(
        default=None,
    ...
    transitTime: Optional[Union[List[Union[Any, str]], Any, str]] = Field(
        default=None,
    ...
    handlingTime: Optional[Union[List[Union[Any, str]], Any, str]] = Field(
        default=None,
    ...
    businessDays: Optional[Union[List[Union[Any, str]], Any, str]] = Field(
        default=None,
