...
class Property(BaseModel):
    ...
    supersededBy: Optional[Union[List[Union[dynamic_creation('Enumeration'), dynamic_creation('Class'), Any, str]], dynamic_creation('Enumeration'), dynamic_creation('Class'), Any, str]] = Field(
        default=None,
        description="Relates a term (i.e. a property, class or enumeration) to one that supersedes it.",
    )
    domainIncludes: Optional[Union[List[Union[dynamic_creation('Class'), str]], dynamic_creation('Class'), str]] = Field(
        default=None,
        description="Relates a property to a class that is (one of) the type(s) the property is expected to be"
     "used on.",
    )
    inverseOf: Optional[Union[List[Union[Any, str]], Any, str]] = Field(
        default=None,
    ...
    rangeIncludes: Optional[Union[List[Union[dynamic_creation('Class'), str]], dynamic_creation('Class'), str]] = Field(
        default=None,
