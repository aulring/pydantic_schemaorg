...
class ProductGroup(BaseModel):
    ...
    variesBy: Optional[Union[List[Union[str, dynamic_creation('Text'), dynamic_creation('DefinedTerm')]], str, dynamic_creation('Text'), dynamic_creation('DefinedTerm')]] = Field(
        default=None,
    ...
    hasVariant: Optional[Union[List[Union[dynamic_creation('Product'), str]], dynamic_creation('Product'), str]] = Field(
        default=None,
        description="Indicates a [[Product]] that is a member of this [[ProductGroup]] (or [[ProductModel]]).",
    )
    productGroupID: Optional[Union[List[Union[str, dynamic_creation('Text')]], str, dynamic_creation('Text')]] = Field(
        default=None,
