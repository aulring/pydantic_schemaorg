...
class ProductGroup(BaseModel):
    ...
    variesBy: Union[List[Union[Any, str]], Any, str] = Field(
        default=None,
    ...
    hasVariant: Optional[Union[List[Union[Any, str]], Any, str]] = Field(
        default=None,
        description="Indicates a [[Product]] that is a member of this [[ProductGroup]] (or [[ProductModel]]).",
    )
    productGroupID: Union[List[Union[Any, str]], Any, str] = Field(
        default=None,
