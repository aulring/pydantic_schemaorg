...
class SoftwareSourceCode(BaseModel):
    ...
    targetProduct: Optional[Union[List[Union[Any, str]], Any, str]] = Field(
        default=None,
    ...
    runtimePlatform: Union[List[Union[Any, str]], Any, str] = Field(
        default=None,
        description="Runtime platform or script interpreter dependencies (example: Java v1, Python 2.3,"
     ".NET Framework 3.0).",
    )
    codeSampleType: Union[List[Union[Any, str]], Any, str] = Field(
        default=None,
        description="What type of code sample: full (compile ready) solution, code snippet, inline code,"
     "scripts, template.",
    )
    runtime: Union[List[Union[Any, str]], Any, str] = Field(
        default=None,
        description="Runtime platform or script interpreter dependencies (example: Java v1, Python 2.3,"
     ".NET Framework 3.0).",
    )
    programmingLanguage: Union[List[Union[Any, str]], Any, str] = Field(
        default=None,
        description="The computer programming language.",
    )
    sampleType: Union[List[Union[Any, str]], Any, str] = Field(
        default=None,
        description="What type of code sample: full (compile ready) solution, code snippet, inline code,"
     "scripts, template.",
    )
    codeRepository: Optional[Union[List[Union[Any, str, AnyUrl]], Any, str, AnyUrl]] = Field(
        default=None,
