...
class SoftwareSourceCode(BaseModel):
    ...
    targetProduct: Optional[Union[List[Union[dynamic_creation('SoftwareApplication'), str]], dynamic_creation('SoftwareApplication'), str]] = Field(
        default=None,
    ...
    runtimePlatform: Optional[Union[List[Union[str, dynamic_creation('Text')]], str, dynamic_creation('Text')]] = Field(
        default=None,
        description="Runtime platform or script interpreter dependencies (example: Java v1, Python 2.3,"
     ".NET Framework 3.0).",
    )
    codeSampleType: Optional[Union[List[Union[str, dynamic_creation('Text')]], str, dynamic_creation('Text')]] = Field(
        default=None,
        description="What type of code sample: full (compile ready) solution, code snippet, inline code,"
     "scripts, template.",
    )
    runtime: Optional[Union[List[Union[str, dynamic_creation('Text')]], str, dynamic_creation('Text')]] = Field(
        default=None,
        description="Runtime platform or script interpreter dependencies (example: Java v1, Python 2.3,"
     ".NET Framework 3.0).",
    )
    programmingLanguage: Optional[Union[List[Union[str, dynamic_creation('Text'), dynamic_creation('ComputerLanguage')]], str, dynamic_creation('Text'), dynamic_creation('ComputerLanguage')]] = Field(
        default=None,
        description="The computer programming language.",
    )
    sampleType: Optional[Union[List[Union[str, dynamic_creation('Text')]], str, dynamic_creation('Text')]] = Field(
        default=None,
        description="What type of code sample: full (compile ready) solution, code snippet, inline code,"
     "scripts, template.",
    )
    codeRepository: Optional[Union[List[Union[AnyUrl, dynamic_creation('URL'), str]], AnyUrl, dynamic_creation('URL'), str]] = Field(
        default=None,
