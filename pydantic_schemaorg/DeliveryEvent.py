...
class DeliveryEvent(BaseModel):
    ...
    availableThrough: Optional[Union[List[Union[datetime, Any, str]], datetime, Any, str]] = Field(
        default=None,
        description="After this date, the item will no longer be available for pickup.",
    )
    accessCode: Union[List[Union[Any, str]], Any, str] = Field(
        default=None,
        description="Password, PIN, or access code needed for delivery (e.g. from a locker).",
    )
    hasDeliveryMethod: Optional[Union[List[Union[Any, str]], Any, str]] = Field(
        default=None,
        description="Method used for delivery or shipping.",
    )
    availableFrom: Optional[Union[List[Union[datetime, Any, str]], datetime, Any, str]] = Field(
        default=None,
