...
class Drug(BaseModel):
    ...
    activeIngredient: Optional[Union[List[Union[str, dynamic_creation('Text')]], str, dynamic_creation('Text')]] = Field(
        default=None,
        description="An active ingredient, typically chemical compounds and/or biologic substances.",
    )
    maximumIntake: Optional[Union[List[Union[dynamic_creation('MaximumDoseSchedule'), str]], dynamic_creation('MaximumDoseSchedule'), str]] = Field(
        default=None,
    ...
    includedInHealthInsurancePlan: Optional[Union[List[Union[dynamic_creation('HealthInsurancePlan'), str]], dynamic_creation('HealthInsurancePlan'), str]] = Field(
        default=None,
        description="The insurance plans that cover this drug.",
    )
    clincalPharmacology: Optional[Union[List[Union[str, dynamic_creation('Text')]], str, dynamic_creation('Text')]] = Field(
        default=None,
    ...
    warning: Optional[Union[List[Union[AnyUrl, dynamic_creation('URL'), str, dynamic_creation('Text')]], AnyUrl, dynamic_creation('URL'), str, dynamic_creation('Text')]] = Field(
        default=None,
    ...
    nonProprietaryName: Optional[Union[List[Union[str, dynamic_creation('Text')]], str, dynamic_creation('Text')]] = Field(
        default=None,
        description="The generic name of this drug or supplement.",
    )
    foodWarning: Optional[Union[List[Union[str, dynamic_creation('Text')]], str, dynamic_creation('Text')]] = Field(
        default=None,
        description="Any precaution, guidance, contraindication, etc. related to consumption of specific"
     "foods while taking this drug.",
    )
    availableStrength: Optional[Union[List[Union[dynamic_creation('DrugStrength'), str]], dynamic_creation('DrugStrength'), str]] = Field(
        default=None,
        description="An available dosage strength for the drug.",
    )
    breastfeedingWarning: Optional[Union[List[Union[str, dynamic_creation('Text')]], str, dynamic_creation('Text')]] = Field(
        default=None,
        description="Any precaution, guidance, contraindication, etc. related to this drug's use by breastfeeding"
     "mothers.",
    )
    dosageForm: Optional[Union[List[Union[str, dynamic_creation('Text')]], str, dynamic_creation('Text')]] = Field(
        default=None,
        description="A dosage form in which this drug/supplement is available, e.g. 'tablet', 'suspension',"
     "'injection'.",
    )
    isAvailableGenerically: Optional[Union[List[Union[StrictBool, dynamic_creation('Boolean'), str]], StrictBool, dynamic_creation('Boolean'), str]] = Field(
        default=None,
    ...
    labelDetails: Optional[Union[List[Union[AnyUrl, dynamic_creation('URL'), str]], AnyUrl, dynamic_creation('URL'), str]] = Field(
        default=None,
        description="Link to the drug's label details.",
    )
    doseSchedule: Optional[Union[List[Union[dynamic_creation('DoseSchedule'), str]], dynamic_creation('DoseSchedule'), str]] = Field(
        default=None,
    ...
    drugUnit: Optional[Union[List[Union[str, dynamic_creation('Text')]], str, dynamic_creation('Text')]] = Field(
        default=None,
        description="The unit in which the drug is measured, e.g. '5 mg tablet'.",
    )
    administrationRoute: Optional[Union[List[Union[str, dynamic_creation('Text')]], str, dynamic_creation('Text')]] = Field(
        default=None,
        description="A route by which this drug may be administered, e.g. 'oral'.",
    )
    proprietaryName: Optional[Union[List[Union[str, dynamic_creation('Text')]], str, dynamic_creation('Text')]] = Field(
        default=None,
        description="Proprietary name given to the diet plan, typically by its originator or creator.",
    )
    clinicalPharmacology: Optional[Union[List[Union[str, dynamic_creation('Text')]], str, dynamic_creation('Text')]] = Field(
        default=None,
        description="Description of the absorption and elimination of drugs, including their concentration"
     "(pharmacokinetics, pK) and biological effects (pharmacodynamics, pD).",
    )
    prescriptionStatus: Optional[Union[List[Union[str, dynamic_creation('Text'), dynamic_creation('DrugPrescriptionStatus')]], str, dynamic_creation('Text'), dynamic_creation('DrugPrescriptionStatus')]] = Field(
        default=None,
    ...
    prescribingInfo: Optional[Union[List[Union[AnyUrl, dynamic_creation('URL'), str]], AnyUrl, dynamic_creation('URL'), str]] = Field(
        default=None,
        description="Link to prescribing information for the drug.",
    )
    pregnancyWarning: Optional[Union[List[Union[str, dynamic_creation('Text')]], str, dynamic_creation('Text')]] = Field(
        default=None,
    ...
    overdosage: Optional[Union[List[Union[str, dynamic_creation('Text')]], str, dynamic_creation('Text')]] = Field(
        default=None,
    ...
    isProprietary: Optional[Union[List[Union[StrictBool, dynamic_creation('Boolean'), str]], StrictBool, dynamic_creation('Boolean'), str]] = Field(
        default=None,
        description="True if this item's name is a proprietary/brand name (vs. generic name).",
    )
    rxcui: Optional[Union[List[Union[str, dynamic_creation('Text')]], str, dynamic_creation('Text')]] = Field(
        default=None,
        description="The RxCUI drug identifier from RXNORM.",
    )
    alcoholWarning: Optional[Union[List[Union[str, dynamic_creation('Text')]], str, dynamic_creation('Text')]] = Field(
        default=None,
        description="Any precaution, guidance, contraindication, etc. related to consumption of alcohol"
     "while taking this drug.",
    )
    drugClass: Optional[Union[List[Union[dynamic_creation('DrugClass'), str]], dynamic_creation('DrugClass'), str]] = Field(
        default=None,
    ...
    pregnancyCategory: Optional[Union[List[Union[dynamic_creation('DrugPregnancyCategory'), str]], dynamic_creation('DrugPregnancyCategory'), str]] = Field(
        default=None,
    ...
    mechanismOfAction: Optional[Union[List[Union[str, dynamic_creation('Text')]], str, dynamic_creation('Text')]] = Field(
        default=None,
