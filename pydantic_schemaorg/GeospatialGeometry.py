...
class GeospatialGeometry(BaseModel):
    ...
    geoCovers: Optional[Union[List[Union[dynamic_creation('Place'), Any, str]], dynamic_creation('Place'), Any, str]] = Field(
        default=None,
    ...
    geoWithin: Optional[Union[List[Union[dynamic_creation('Place'), Any, str]], dynamic_creation('Place'), Any, str]] = Field(
        default=None,
        description="Represents a relationship between two geometries (or the places they represent), relating"
    ...
    geoOverlaps: Optional[Union[List[Union[dynamic_creation('Place'), Any, str]], dynamic_creation('Place'), Any, str]] = Field(
        default=None,
        description="Represents a relationship between two geometries (or the places they represent), relating"
    ...
    geoEquals: Optional[Union[List[Union[dynamic_creation('Place'), Any, str]], dynamic_creation('Place'), Any, str]] = Field(
        default=None,
    ...
    geoCrosses: Optional[Union[List[Union[dynamic_creation('Place'), Any, str]], dynamic_creation('Place'), Any, str]] = Field(
        default=None,
        description="Represents a relationship between two geometries (or the places they represent), relating"
    ...
    geoDisjoint: Optional[Union[List[Union[dynamic_creation('Place'), Any, str]], dynamic_creation('Place'), Any, str]] = Field(
        default=None,
        description="Represents spatial relations in which two geometries (or the places they represent)"
    ...
    geoIntersects: Optional[Union[List[Union[dynamic_creation('Place'), Any, str]], dynamic_creation('Place'), Any, str]] = Field(
        default=None,
        description="Represents spatial relations in which two geometries (or the places they represent)"
     "have at least one point in common. As defined in [DE-9IM](https://en.wikipedia.org/wiki/DE-9IM).",
    )
    geoTouches: Optional[Union[List[Union[dynamic_creation('Place'), Any, str]], dynamic_creation('Place'), Any, str]] = Field(
        default=None,
        description="Represents spatial relations in which two geometries (or the places they represent)"
    ...
    geoCoveredBy: Optional[Union[List[Union[dynamic_creation('Place'), Any, str]], dynamic_creation('Place'), Any, str]] = Field(
        default=None,
        description="Represents a relationship between two geometries (or the places they represent), relating"
     "a geometry to another that covers it. As defined in [DE-9IM](https://en.wikipedia.org/wiki/DE-9IM).",
    )
    geoContains: Optional[Union[List[Union[dynamic_creation('Place'), Any, str]], dynamic_creation('Place'), Any, str]] = Field(
        default=None,
        description="Represents a relationship between two geometries (or the places they represent), relating"
