...
class MedicalConditionStage(BaseModel):
    ...
    subStageSuffix: Union[List[Union[Any, str]], Any, str] = Field(
        default=None,
        description="The substage, e.g. 'a' for Stage IIIa.",
    )
    stageAsNumber: Optional[Union[List[Union[Any, StrictInt, StrictFloat, str]], Any, StrictInt, StrictFloat, str]] = Field(
        default=None,
