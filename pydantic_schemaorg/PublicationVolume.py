...
class PublicationVolume(BaseModel):
    ...
    volumeNumber: Optional[Union[List[Union[int, dynamic_creation('Integer'), str, dynamic_creation('Text')]], int, dynamic_creation('Integer'), str, dynamic_creation('Text')]] = Field(
        default=None,
