...
class Audiobook(BaseModel):
    ...
    abridged: Optional[Union[List[Union[StrictBool, Any, str]], StrictBool, Any, str]] = Field(
        default=None,
        description="Indicates whether the book is an abridged edition.",
    )
    bookFormat: Optional[Union[List[Union[Any, str]], Any, str]] = Field(
        default=None,
        description="The format of the book.",
    )
    illustrator: Optional[Union[List[Union[Any, str]], Any, str]] = Field(
        default=None,
        description="The illustrator of the book.",
    )
    bookEdition: Union[List[Union[Any, str]], Any, str] = Field(
        default=None,
        description="The edition of the book.",
    )
    numberOfPages: Optional[Union[List[Union[Any, int, str]], Any, int, str]] = Field(
        default=None,
        description="The number of pages in the book.",
    )
    isbn: Union[List[Union[Any, str]], Any, str] = Field(
        default=None,
    ...
    readBy: Optional[Union[List[Union[Any, str]], Any, str]] = Field(
        default=None,
