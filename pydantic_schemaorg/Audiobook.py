...
class Audiobook(BaseModel):
    ...
    abridged: Optional[Union[List[Union[StrictBool, dynamic_creation('Boolean'), str]], StrictBool, dynamic_creation('Boolean'), str]] = Field(
        default=None,
        description="Indicates whether the book is an abridged edition.",
    )
    bookFormat: Optional[Union[List[Union[dynamic_creation('BookFormatType'), str]], dynamic_creation('BookFormatType'), str]] = Field(
        default=None,
        description="The format of the book.",
    )
    illustrator: Optional[Union[List[Union[dynamic_creation('Person'), str]], dynamic_creation('Person'), str]] = Field(
        default=None,
        description="The illustrator of the book.",
    )
    bookEdition: Optional[Union[List[Union[str, dynamic_creation('Text')]], str, dynamic_creation('Text')]] = Field(
        default=None,
        description="The edition of the book.",
    )
    numberOfPages: Optional[Union[List[Union[int, dynamic_creation('Integer'), str]], int, dynamic_creation('Integer'), str]] = Field(
        default=None,
        description="The number of pages in the book.",
    )
    isbn: Optional[Union[List[Union[str, dynamic_creation('Text')]], str, dynamic_creation('Text')]] = Field(
        default=None,
    ...
    readBy: Optional[Union[List[Union[dynamic_creation('Person'), str]], dynamic_creation('Person'), str]] = Field(
        default=None,
