...
class DietarySupplement(BaseModel):
    ...
    safetyConsideration: Optional[Union[List[Union[str, dynamic_creation('Text')]], str, dynamic_creation('Text')]] = Field(
        default=None,
    ...
    targetPopulation: Optional[Union[List[Union[str, dynamic_creation('Text')]], str, dynamic_creation('Text')]] = Field(
        default=None,
    ...
    recommendedIntake: Optional[Union[List[Union[dynamic_creation('RecommendedDoseSchedule'), str]], dynamic_creation('RecommendedDoseSchedule'), str]] = Field(
        default=None,
        description="Recommended intake of this supplement for a given population as defined by a specific"
     "recommending authority.",
    )
