...
class SuperficialAnatomy(BaseModel):
    ...
    relatedAnatomy: Optional[Union[List[Union[dynamic_creation('AnatomicalStructure'), dynamic_creation('AnatomicalSystem'), str]], dynamic_creation('AnatomicalStructure'), dynamic_creation('AnatomicalSystem'), str]] = Field(
        default=None,
    ...
    significance: Optional[Union[List[Union[str, dynamic_creation('Text')]], str, dynamic_creation('Text')]] = Field(
        default=None,
