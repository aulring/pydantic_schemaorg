...
class Question(BaseModel):
    ...
    downvoteCount: Optional[Union[List[Union[int, dynamic_creation('Integer'), str]], int, dynamic_creation('Integer'), str]] = Field(
        default=None,
        description="The number of downvotes this question, answer or comment has received from the community.",
    )
    upvoteCount: Optional[Union[List[Union[int, dynamic_creation('Integer'), str]], int, dynamic_creation('Integer'), str]] = Field(
        default=None,
        description="The number of upvotes this question, answer or comment has received from the community.",
    )
    acceptedAnswer: Optional[Union[List[Union[dynamic_creation('ItemList'), dynamic_creation('Answer'), str]], dynamic_creation('ItemList'), dynamic_creation('Answer'), str]] = Field(
        default=None,
    ...
    suggestedAnswer: Optional[Union[List[Union[dynamic_creation('ItemList'), dynamic_creation('Answer'), str]], dynamic_creation('ItemList'), dynamic_creation('Answer'), str]] = Field(
        default=None,
        description="An answer (possibly one of several, possibly incorrect) to a Question, e.g. on a Question/Answer"
     "site.",
    )
    answerCount: Optional[Union[List[Union[int, dynamic_creation('Integer'), str]], int, dynamic_creation('Integer'), str]] = Field(
        default=None,
        description="The number of answers this question has received.",
    )
    eduQuestionType: Optional[Union[List[Union[str, dynamic_creation('Text')]], str, dynamic_creation('Text')]] = Field(
        default=None,
