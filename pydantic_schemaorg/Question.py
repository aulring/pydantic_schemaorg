...
class Question(BaseModel):
    ...
    suggestedAnswer: Optional[Union[List[Union[Any, str]], Any, str]] = Field(
        default=None,
        description="An answer (possibly one of several, possibly incorrect) to a Question, e.g. on a Question/Answer"
     "site.",
    )
    answerCount: Optional[Union[List[Union[Any, int, str]], Any, int, str]] = Field(
        default=None,
        description="The number of answers this question has received.",
    )
    eduQuestionType: Union[List[Union[Any, str]], Any, str] = Field(
        default=None,
