...
class PaymentChargeSpecification(BaseModel):
    ...
    appliesToPaymentMethod: Optional[Union[List[Union[dynamic_creation('PaymentMethod'), str]], dynamic_creation('PaymentMethod'), str]] = Field(
        default=None,
        description="The payment method(s) to which the payment charge specification applies.",
    )
    appliesToDeliveryMethod: Optional[Union[List[Union[dynamic_creation('DeliveryMethod'), str]], dynamic_creation('DeliveryMethod'), str]] = Field(
        default=None,
