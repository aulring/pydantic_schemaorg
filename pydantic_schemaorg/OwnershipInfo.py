...
class OwnershipInfo(BaseModel):
    ...
    ownedThrough: Optional[Union[List[Union[datetime, Any, str]], datetime, Any, str]] = Field(
        default=None,
        description="The date and time of giving up ownership on the product.",
    )
    ownedFrom: Optional[Union[List[Union[datetime, Any, str]], datetime, Any, str]] = Field(
        default=None,
        description="The date and time of obtaining the product.",
    )
    acquiredFrom: Optional[Union[List[Union[Any, str]], Any, str]] = Field(
        default=None,
