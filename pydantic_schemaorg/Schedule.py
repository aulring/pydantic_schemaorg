...
class Schedule(BaseModel):
    ...
    exceptDate: Optional[Union[List[Union[datetime, dynamic_creation('DateTime'), date, dynamic_creation('Date'), str]], datetime, dynamic_creation('DateTime'), date, dynamic_creation('Date'), str]] = Field(
        default=None,
    ...
    repeatFrequency: Optional[Union[List[Union[str, dynamic_creation('Text'), dynamic_creation('Duration')]], str, dynamic_creation('Text'), dynamic_creation('Duration')]] = Field(
        default=None,
    ...
    scheduleTimezone: Optional[Union[List[Union[str, dynamic_creation('Text')]], str, dynamic_creation('Text')]] = Field(
        default=None,
    ...
    byMonthWeek: Optional[Union[List[Union[int, dynamic_creation('Integer'), str]], int, dynamic_creation('Integer'), str]] = Field(
        default=None,
    ...
    byDay: Optional[Union[List[Union[str, dynamic_creation('Text'), dynamic_creation('DayOfWeek')]], str, dynamic_creation('Text'), dynamic_creation('DayOfWeek')]] = Field(
        default=None,
    ...
    byMonthDay: Optional[Union[List[Union[int, dynamic_creation('Integer'), str]], int, dynamic_creation('Integer'), str]] = Field(
        default=None,
        description="Defines the day(s) of the month on which a recurring [[Event]] takes place. Specified"
     "as an [[Integer]] between 1-31.",
    )
    repeatCount: Optional[Union[List[Union[int, dynamic_creation('Integer'), str]], int, dynamic_creation('Integer'), str]] = Field(
        default=None,
        description="Defines the number of times a recurring [[Event]] will take place.",
    )
    byMonth: Optional[Union[List[Union[int, dynamic_creation('Integer'), str]], int, dynamic_creation('Integer'), str]] = Field(
        default=None,
