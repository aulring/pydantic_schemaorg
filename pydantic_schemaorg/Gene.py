...
class Gene(BaseModel):
    ...
    expressedIn: Optional[Union[List[Union[dynamic_creation('DefinedTerm'), dynamic_creation('BioChemEntity'), dynamic_creation('AnatomicalStructure'), dynamic_creation('AnatomicalSystem'), str]], dynamic_creation('DefinedTerm'), dynamic_creation('BioChemEntity'), dynamic_creation('AnatomicalStructure'), dynamic_creation('AnatomicalSystem'), str]] = Field(
        default=None,
    ...
    hasBioPolymerSequence: Optional[Union[List[Union[str, dynamic_creation('Text')]], str, dynamic_creation('Text')]] = Field(
        default=None,
    ...
    encodesBioChemEntity: Optional[Union[List[Union[dynamic_creation('BioChemEntity'), str]], dynamic_creation('BioChemEntity'), str]] = Field(
        default=None,
        description="Another BioChemEntity encoded by this one.",
    )
    alternativeOf: Optional[Union[List[Union[Any, str]], Any, str]] = Field(
        default=None,
