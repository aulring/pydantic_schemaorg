...
class Gene(BaseModel):
    ...
    expressedIn: Optional[Union[List[Union[DefinedTerm, AnatomicalStructure, AnatomicalSystem, BioChemEntity, str]], DefinedTerm, AnatomicalStructure, AnatomicalSystem, BioChemEntity, str]] = Field(
        default=None,
