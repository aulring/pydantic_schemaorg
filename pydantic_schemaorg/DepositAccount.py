...
class DepositAccount(BaseModel):
    ...
    accountMinimumInflow: Optional[Union[List[Union[dynamic_creation('MonetaryAmount'), str]], dynamic_creation('MonetaryAmount'), str]] = Field(
        default=None,
        description="A minimum amount that has to be paid in every month.",
    )
    accountOverdraftLimit: Optional[Union[List[Union[dynamic_creation('MonetaryAmount'), str]], dynamic_creation('MonetaryAmount'), str]] = Field(
        default=None,
    ...
    bankAccountType: Optional[Union[List[Union[AnyUrl, dynamic_creation('URL'), str, dynamic_creation('Text')]], AnyUrl, dynamic_creation('URL'), str, dynamic_creation('Text')]] = Field(
        default=None,
