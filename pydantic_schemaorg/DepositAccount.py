...
class DepositAccount(BaseModel):
    ...
    accountMinimumInflow: Optional[Union[List[Union[Any, str]], Any, str]] = Field(
        default=None,
        description="A minimum amount that has to be paid in every month.",
    )
    accountOverdraftLimit: Optional[Union[List[Union[Any, str]], Any, str]] = Field(
        default=None,
    ...
    bankAccountType: Union[List[Union[Any, str, AnyUrl]], Any, str, AnyUrl] = Field(
        default=None,
