...
class NutritionInformation(BaseModel):
    ...
    sodiumContent: Optional[Union[List[Union[dynamic_creation('Mass'), str]], dynamic_creation('Mass'), str]] = Field(
        default=None,
        description="The number of milligrams of sodium.",
    )
    carbohydrateContent: Optional[Union[List[Union[dynamic_creation('Mass'), str]], dynamic_creation('Mass'), str]] = Field(
        default=None,
        description="The number of grams of carbohydrates.",
    )
    fatContent: Optional[Union[List[Union[dynamic_creation('Mass'), str]], dynamic_creation('Mass'), str]] = Field(
        default=None,
        description="The number of grams of fat.",
    )
    cholesterolContent: Optional[Union[List[Union[dynamic_creation('Mass'), str]], dynamic_creation('Mass'), str]] = Field(
        default=None,
        description="The number of milligrams of cholesterol.",
    )
    calories: Optional[Union[List[Union[dynamic_creation('Energy'), str]], dynamic_creation('Energy'), str]] = Field(
        default=None,
        description="The number of calories.",
    )
    unsaturatedFatContent: Optional[Union[List[Union[dynamic_creation('Mass'), str]], dynamic_creation('Mass'), str]] = Field(
        default=None,
        description="The number of grams of unsaturated fat.",
    )
    sugarContent: Optional[Union[List[Union[dynamic_creation('Mass'), str]], dynamic_creation('Mass'), str]] = Field(
        default=None,
        description="The number of grams of sugar.",
    )
    transFatContent: Optional[Union[List[Union[dynamic_creation('Mass'), str]], dynamic_creation('Mass'), str]] = Field(
        default=None,
        description="The number of grams of trans fat.",
    )
    proteinContent: Optional[Union[List[Union[dynamic_creation('Mass'), str]], dynamic_creation('Mass'), str]] = Field(
        default=None,
        description="The number of grams of protein.",
    )
    saturatedFatContent: Optional[Union[List[Union[dynamic_creation('Mass'), str]], dynamic_creation('Mass'), str]] = Field(
        default=None,
        description="The number of grams of saturated fat.",
    )
    servingSize: Optional[Union[List[Union[str, dynamic_creation('Text')]], str, dynamic_creation('Text')]] = Field(
        default=None,
        description="The serving size, in terms of the number of volume or mass.",
    )
    fiberContent: Optional[Union[List[Union[dynamic_creation('Mass'), str]], dynamic_creation('Mass'), str]] = Field(
        default=None,
