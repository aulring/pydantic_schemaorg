...
class SportsTeam(BaseModel):
    ...
    sport: Union[List[Union[Any, str, AnyUrl]], Any, str, AnyUrl] = Field(
        default=None,
        description="A type of sport (e.g. Baseball).",
    )
    athlete: Optional[Union[List[Union[Any, str]], Any, str]] = Field(
        default=None,
        description="A person that acts as performing member of a sports team; a player as opposed to a coach.",
    )
    gender: Union[List[Union[Any, str]], Any, str] = Field(
        default=None,
    ...
    coach: Optional[Union[List[Union[Any, str]], Any, str]] = Field(
        default=None,
