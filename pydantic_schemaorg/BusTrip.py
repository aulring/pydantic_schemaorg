...
class BusTrip(BaseModel):
    ...
    busName: Optional[Union[List[Union[str, dynamic_creation('Text')]], str, dynamic_creation('Text')]] = Field(
        default=None,
        description="The name of the bus (e.g. Bolt Express).",
    )
    busNumber: Optional[Union[List[Union[str, dynamic_creation('Text')]], str, dynamic_creation('Text')]] = Field(
        default=None,
        description="The unique identifier for the bus.",
    )
    departureBusStop: Optional[Union[List[Union[dynamic_creation('BusStop'), dynamic_creation('BusStation'), str]], dynamic_creation('BusStop'), dynamic_creation('BusStation'), str]] = Field(
        default=None,
        description="The stop or station from which the bus departs.",
    )
    arrivalBusStop: Optional[Union[List[Union[dynamic_creation('BusStop'), dynamic_creation('BusStation'), str]], dynamic_creation('BusStop'), dynamic_creation('BusStation'), str]] = Field(
        default=None,
