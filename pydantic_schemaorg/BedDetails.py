...
class BedDetails(BaseModel):
    ...
    typeOfBed: Union[List[Union[Any, str]], Any, str] = Field(
        default=None,
    ...
    numberOfBeds: Optional[Union[List[Union[Any, StrictInt, StrictFloat, str]], Any, StrictInt, StrictFloat, str]] = Field(
        default=None,
