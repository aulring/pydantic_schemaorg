...
class BedDetails(BaseModel):
    ...
    typeOfBed: Optional[Union[List[Union[str, dynamic_creation('Text'), dynamic_creation('BedType')]], str, dynamic_creation('Text'), dynamic_creation('BedType')]] = Field(
        default=None,
    ...
    numberOfBeds: Optional[Union[List[Union[StrictInt, StrictFloat, dynamic_creation('Number'), str]], StrictInt, StrictFloat, dynamic_creation('Number'), str]] = Field(
        default=None,
