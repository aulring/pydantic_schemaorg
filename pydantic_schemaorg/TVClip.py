...
class TVClip(BaseModel):
    ...
    clipNumber: Union[List[Union[Any, int, str]], Any, int, str] = Field(
        default=None,
        description="Position of the clip within an ordered group of clips.",
    )
    partOfEpisode: Optional[Union[List[Union[Any, str]], Any, str]] = Field(
        default=None,
        description="The episode to which this clip belongs.",
    )
    partOfSeason: Optional[Union[List[Union[Any, str]], Any, str]] = Field(
        default=None,
        description="The season to which this episode belongs.",
    )
    startOffset: Optional[Union[List[Union[Any, StrictInt, StrictFloat, str]], Any, StrictInt, StrictFloat, str]] = Field(
        default=None,
        description="The start time of the clip expressed as the number of seconds from the beginning of the"
     "work.",
    )
    partOfSeries: Optional[Union[List[Union[Any, str]], Any, str]] = Field(
        default=None,
        description="The series to which this episode or season belongs.",
    )
    endOffset: Optional[Union[List[Union[Any, StrictInt, StrictFloat, str]], Any, StrictInt, StrictFloat, str]] = Field(
        default=None,
    ...
    partOfTVSeries: Optional[Union[List[Union[Any, str]], Any, str]] = Field(
        default=None,
