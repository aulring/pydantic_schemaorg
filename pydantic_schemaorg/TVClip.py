...
class TVClip(BaseModel):
    ...
    clipNumber: Optional[Union[List[Union[int, dynamic_creation('Integer'), str, dynamic_creation('Text')]], int, dynamic_creation('Integer'), str, dynamic_creation('Text')]] = Field(
        default=None,
        description="Position of the clip within an ordered group of clips.",
    )
    partOfEpisode: Optional[Union[List[Union[dynamic_creation('Episode'), str]], dynamic_creation('Episode'), str]] = Field(
        default=None,
    ...
    startOffset: Optional[Union[List[Union[StrictInt, StrictFloat, dynamic_creation('Number'), dynamic_creation('HyperTocEntry'), str]], StrictInt, StrictFloat, dynamic_creation('Number'), dynamic_creation('HyperTocEntry'), str]] = Field(
        default=None,
    ...
    endOffset: Optional[Union[List[Union[StrictInt, StrictFloat, dynamic_creation('Number'), dynamic_creation('HyperTocEntry'), str]], StrictInt, StrictFloat, dynamic_creation('Number'), dynamic_creation('HyperTocEntry'), str]] = Field(
        default=None,
