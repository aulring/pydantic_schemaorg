...
class HowToDirection(BaseModel):
    ...
    item: Optional[Union[List[Union[Any, str]], Any, str]] = Field(
        default=None,
    ...
    afterMedia: Optional[Union[List[Union[Any, str, AnyUrl]], Any, str, AnyUrl]] = Field(
        default=None,
        description="A media object representing the circumstances after performing this direction.",
    )
    beforeMedia: Optional[Union[List[Union[Any, str, AnyUrl]], Any, str, AnyUrl]] = Field(
        default=None,
    ...
    duringMedia: Optional[Union[List[Union[Any, str, AnyUrl]], Any, str, AnyUrl]] = Field(
        default=None,
