...
class HowToDirection(BaseModel):
    ...
    afterMedia: Optional[Union[List[Union[AnyUrl, dynamic_creation('URL'), dynamic_creation('MediaObject'), str]], AnyUrl, dynamic_creation('URL'), dynamic_creation('MediaObject'), str]] = Field(
        default=None,
        description="A media object representing the circumstances after performing this direction.",
    )
    beforeMedia: Optional[Union[List[Union[AnyUrl, dynamic_creation('URL'), dynamic_creation('MediaObject'), str]], AnyUrl, dynamic_creation('URL'), dynamic_creation('MediaObject'), str]] = Field(
        default=None,
    ...
    duringMedia: Optional[Union[List[Union[AnyUrl, dynamic_creation('URL'), dynamic_creation('MediaObject'), str]], AnyUrl, dynamic_creation('URL'), dynamic_creation('MediaObject'), str]] = Field(
        default=None,
