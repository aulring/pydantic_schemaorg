...
class UserComments(BaseModel):
    ...
    commentText: Union[List[Union[Any, str]], Any, str] = Field(
        default=None,
        description="The text of the UserComment.",
    )
    replyToUrl: Optional[Union[List[Union[Any, str, AnyUrl]], Any, str, AnyUrl]] = Field(
        default=None,
    ...
    commentTime: Optional[Union[List[Union[datetime, date, Any, str]], datetime, date, Any, str]] = Field(
        default=None,
        description="The time at which the UserComment was made.",
    )
    discusses: Optional[Union[List[Union[Any, str]], Any, str]] = Field(
        default=None,
