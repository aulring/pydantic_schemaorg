...
class AggregateOffer(BaseModel):
    ...
    deliveryLeadTime: Optional[Union[List[Union[dynamic_creation('QuantitativeValue'), str]], dynamic_creation('QuantitativeValue'), str]] = Field(
        default=None,
    ...
    advanceBookingRequirement: Optional[Union[List[Union[dynamic_creation('QuantitativeValue'), str]], dynamic_creation('QuantitativeValue'), str]] = Field(
        default=None,
    ...
    priceValidUntil: Optional[Union[List[Union[date, dynamic_creation('Date'), str]], date, dynamic_creation('Date'), str]] = Field(
        default=None,
    ...
    warranty: Optional[Union[List[Union[dynamic_creation('WarrantyPromise'), str]], dynamic_creation('WarrantyPromise'), str]] = Field(
        default=None,
        description="The warranty promise(s) included in the offer.",
    )
    inventoryLevel: Optional[Union[List[Union[dynamic_creation('QuantitativeValue'), str]], dynamic_creation('QuantitativeValue'), str]] = Field(
        default=None,
        description="The current approximate inventory level for the item or items.",
    )
    eligibleDuration: Optional[Union[List[Union[dynamic_creation('QuantitativeValue'), str]], dynamic_creation('QuantitativeValue'), str]] = Field(
        default=None,
        description="The duration for which the given offer is valid.",
    )
    availability: Optional[Union[List[Union[dynamic_creation('ItemAvailability'), str]], dynamic_creation('ItemAvailability'), str]] = Field(
        default=None,
    ...
    checkoutPageURLTemplate: Optional[Union[List[Union[str, dynamic_creation('Text')]], str, dynamic_creation('Text')]] = Field(
        default=None,
    ...
    itemOffered: Optional[Union[List[Union[dynamic_creation('AggregateOffer'), dynamic_creation('CreativeWork'), dynamic_creation('Product'), dynamic_creation('Trip'), dynamic_creation('Event'), dynamic_creation('Service'), dynamic_creation('MenuItem'), str]], dynamic_creation('AggregateOffer'), dynamic_creation('CreativeWork'), dynamic_creation('Product'), dynamic_creation('Trip'), dynamic_creation('Event'), dynamic_creation('Service'), dynamic_creation('MenuItem'), str]] = Field(
        default=None,
    ...
    shippingDetails: Optional[Union[List[Union[dynamic_creation('OfferShippingDetails'), str]], dynamic_creation('OfferShippingDetails'), str]] = Field(
        default=None,
    ...
    businessFunction: Optional[Union[List[Union[dynamic_creation('BusinessFunction'), str]], dynamic_creation('BusinessFunction'), str]] = Field(
        default=None,
    ...
    priceSpecification: Optional[Union[List[Union[dynamic_creation('PriceSpecification'), str]], dynamic_creation('PriceSpecification'), str]] = Field(
        default=None,
    ...
    eligibleTransactionVolume: Optional[Union[List[Union[dynamic_creation('PriceSpecification'), str]], dynamic_creation('PriceSpecification'), str]] = Field(
        default=None,
    ...
    offeredBy: Optional[Union[List[Union[dynamic_creation('Organization'), dynamic_creation('Person'), str]], dynamic_creation('Organization'), dynamic_creation('Person'), str]] = Field(
        default=None,
        description="A pointer to the organization or person making the offer.",
    )
    addOn: Optional[Union[List[Union[Any, str]], Any, str]] = Field(
        default=None,
    ...
    availableAtOrFrom: Optional[Union[List[Union[dynamic_creation('Place'), str]], dynamic_creation('Place'), str]] = Field(
        default=None,
    ...
    eligibleCustomerType: Optional[Union[List[Union[dynamic_creation('BusinessEntityType'), str]], dynamic_creation('BusinessEntityType'), str]] = Field(
        default=None,
    ...
    serialNumber: Optional[Union[List[Union[str, dynamic_creation('Text')]], str, dynamic_creation('Text')]] = Field(
        default=None,
    ...
    acceptedPaymentMethod: Optional[Union[List[Union[dynamic_creation('PaymentMethod'), dynamic_creation('LoanOrCredit'), str]], dynamic_creation('PaymentMethod'), dynamic_creation('LoanOrCredit'), str]] = Field(
        default=None,
        description="The payment method(s) accepted by seller for this offer.",
    )
    availableDeliveryMethod: Optional[Union[List[Union[dynamic_creation('DeliveryMethod'), str]], dynamic_creation('DeliveryMethod'), str]] = Field(
        default=None,
        description="The delivery method(s) available for this offer.",
    )
    highPrice: Optional[Union[List[Union[StrictInt, StrictFloat, dynamic_creation('Number'), str, dynamic_creation('Text')]], StrictInt, StrictFloat, dynamic_creation('Number'), str, dynamic_creation('Text')]] = Field(
        default=None,
    ...
    offerCount: Optional[Union[List[Union[int, dynamic_creation('Integer'), str]], int, dynamic_creation('Integer'), str]] = Field(
        default=None,
        description="The number of offers for the product.",
    )
    lowPrice: Optional[Union[List[Union[StrictInt, StrictFloat, dynamic_creation('Number'), str, dynamic_creation('Text')]], StrictInt, StrictFloat, dynamic_creation('Number'), str, dynamic_creation('Text')]] = Field(
        default=None,
