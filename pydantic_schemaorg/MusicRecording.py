...
class MusicRecording(BaseModel):
    ...
    recordingOf: Optional[Union[List[Union[dynamic_creation('MusicComposition'), str]], dynamic_creation('MusicComposition'), str]] = Field(
        default=None,
    ...
    inPlaylist: Optional[Union[List[Union[dynamic_creation('MusicPlaylist'), str]], dynamic_creation('MusicPlaylist'), str]] = Field(
        default=None,
    ...
    isrcCode: Optional[Union[List[Union[str, dynamic_creation('Text')]], str, dynamic_creation('Text')]] = Field(
        default=None,
        description="The International Standard Recording Code for the recording.",
    )
    inAlbum: Optional[Union[List[Union[dynamic_creation('MusicAlbum'), str]], dynamic_creation('MusicAlbum'), str]] = Field(
        default=None,
