...
class MusicRecording(BaseModel):
    ...
    recordingOf: Optional[Union[List[Union[Any, str]], Any, str]] = Field(
        default=None,
    ...
    inPlaylist: Optional[Union[List[Union[Any, str]], Any, str]] = Field(
        default=None,
    ...
    isrcCode: Union[List[Union[Any, str]], Any, str] = Field(
        default=None,
        description="The International Standard Recording Code for the recording.",
    )
    inAlbum: Optional[Union[List[Union[Any, str]], Any, str]] = Field(
        default=None,
