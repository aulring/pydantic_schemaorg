...
class TVEpisode(BaseModel):
    ...
    episodeNumber: Union[List[Union[Any, int, str]], Any, int, str] = Field(
        default=None,
    ...
    titleEIDR: Union[List[Union[Any, str, AnyUrl]], Any, str, AnyUrl] = Field(
        default=None,
        description="An [EIDR](https://eidr.org/) (Entertainment Identifier Registry) [[identifier]]"
    ...
    subtitleLanguage: Union[List[Union[Any, str]], Any, str] = Field(
        default=None,
