...
class TVEpisode(BaseModel):
    ...
    partOfSeason: Optional[Union[List[Union[dynamic_creation('CreativeWorkSeason'), str]], dynamic_creation('CreativeWorkSeason'), str]] = Field(
        default=None,
        description="The season to which this episode belongs.",
    )
    partOfSeries: Optional[Union[List[Union[dynamic_creation('CreativeWorkSeries'), str]], dynamic_creation('CreativeWorkSeries'), str]] = Field(
        default=None,
    ...
    episodeNumber: Optional[Union[List[Union[int, dynamic_creation('Integer'), str, dynamic_creation('Text')]], int, dynamic_creation('Integer'), str, dynamic_creation('Text')]] = Field(
        default=None,
    ...
    partOfTVSeries: Optional[Union[List[Union[dynamic_creation('TVSeries'), str]], dynamic_creation('TVSeries'), str]] = Field(
        default=None,
        description="The TV series to which this episode or season belongs.",
    )
    titleEIDR: Optional[Union[List[Union[AnyUrl, dynamic_creation('URL'), str, dynamic_creation('Text')]], AnyUrl, dynamic_creation('URL'), str, dynamic_creation('Text')]] = Field(
        default=None,
        description="An [EIDR](https://eidr.org/) (Entertainment Identifier Registry) [[identifier]]"
