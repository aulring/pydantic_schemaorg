...
class Ticket(BaseModel):
    ...
    ticketNumber: Optional[Union[List[Union[str, dynamic_creation('Text')]], str, dynamic_creation('Text')]] = Field(
        default=None,
    ...
    ticketToken: Optional[Union[List[Union[AnyUrl, dynamic_creation('URL'), str, dynamic_creation('Text')]], AnyUrl, dynamic_creation('URL'), str, dynamic_creation('Text')]] = Field(
        default=None,
    ...
    ticketedSeat: Optional[Union[List[Union[dynamic_creation('Seat'), str]], dynamic_creation('Seat'), str]] = Field(
        default=None,
    ...
    dateIssued: Optional[Union[List[Union[datetime, dynamic_creation('DateTime'), date, dynamic_creation('Date'), str]], datetime, dynamic_creation('DateTime'), date, dynamic_creation('Date'), str]] = Field(
        default=None,
