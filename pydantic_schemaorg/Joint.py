...
class Joint(BaseModel):
    ...
    structuralClass: Union[List[Union[Any, str]], Any, str] = Field(
        default=None,
        description="The name given to how bone physically connects to each other.",
    )
    functionalClass: Union[List[Union[Any, str]], Any, str] = Field(
        default=None,
        description="The degree of mobility the joint allows.",
    )
    biomechnicalClass: Union[List[Union[Any, str]], Any, str] = Field(
        default=None,
