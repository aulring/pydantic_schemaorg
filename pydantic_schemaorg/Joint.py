...
class Joint(BaseModel):
    ...
    structuralClass: Optional[Union[List[Union[str, dynamic_creation('Text')]], str, dynamic_creation('Text')]] = Field(
        default=None,
        description="The name given to how bone physically connects to each other.",
    )
    functionalClass: Optional[Union[List[Union[str, dynamic_creation('Text'), dynamic_creation('MedicalEntity')]], str, dynamic_creation('Text'), dynamic_creation('MedicalEntity')]] = Field(
        default=None,
        description="The degree of mobility the joint allows.",
    )
    biomechnicalClass: Optional[Union[List[Union[str, dynamic_creation('Text')]], str, dynamic_creation('Text')]] = Field(
        default=None,
