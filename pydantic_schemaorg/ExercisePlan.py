...
class ExercisePlan(BaseModel):
    ...
    additionalVariable: Optional[Union[List[Union[str, dynamic_creation('Text')]], str, dynamic_creation('Text')]] = Field(
        default=None,
    ...
    activityFrequency: Optional[Union[List[Union[str, dynamic_creation('Text'), dynamic_creation('QuantitativeValue')]], str, dynamic_creation('Text'), dynamic_creation('QuantitativeValue')]] = Field(
        default=None,
        description="How often one should engage in the activity.",
    )
    repetitions: Optional[Union[List[Union[StrictInt, StrictFloat, dynamic_creation('Number'), dynamic_creation('QuantitativeValue'), str]], StrictInt, StrictFloat, dynamic_creation('Number'), dynamic_creation('QuantitativeValue'), str]] = Field(
        default=None,
        description="Number of times one should repeat the activity.",
    )
    intensity: Optional[Union[List[Union[str, dynamic_creation('Text'), dynamic_creation('QuantitativeValue')]], str, dynamic_creation('Text'), dynamic_creation('QuantitativeValue')]] = Field(
        default=None,
    ...
    activityDuration: Optional[Union[List[Union[dynamic_creation('QuantitativeValue'), dynamic_creation('Duration'), str]], dynamic_creation('QuantitativeValue'), dynamic_creation('Duration'), str]] = Field(
        default=None,
    ...
    workload: Optional[Union[List[Union[dynamic_creation('Energy'), dynamic_creation('QuantitativeValue'), str]], dynamic_creation('Energy'), dynamic_creation('QuantitativeValue'), str]] = Field(
        default=None,
        description="Quantitative measure of the physiologic output of the exercise; also referred to as"
     "energy expenditure.",
    )
    restPeriods: Optional[Union[List[Union[str, dynamic_creation('Text'), dynamic_creation('QuantitativeValue')]], str, dynamic_creation('Text'), dynamic_creation('QuantitativeValue')]] = Field(
        default=None,
