...
class Vein(BaseModel):
    ...
    tributary: Optional[Union[List[Union[dynamic_creation('AnatomicalStructure'), str]], dynamic_creation('AnatomicalStructure'), str]] = Field(
        default=None,
        description="The anatomical or organ system that the vein flows into; a larger structure that the vein"
     "connects to.",
    )
    regionDrained: Optional[Union[List[Union[dynamic_creation('AnatomicalStructure'), dynamic_creation('AnatomicalSystem'), str]], dynamic_creation('AnatomicalStructure'), dynamic_creation('AnatomicalSystem'), str]] = Field(
        default=None,
        description="The anatomical or organ system drained by this vessel; generally refers to a specific"
     "part of an organ.",
    )
    drainsTo: Optional[Union[List[Union[dynamic_creation('Vessel'), str]], dynamic_creation('Vessel'), str]] = Field(
        default=None,
