...
class HealthPlanFormulary(BaseModel):
    ...
    healthPlanCostSharing: Optional[Union[List[Union[StrictBool, Any, str]], StrictBool, Any, str]] = Field(
        default=None,
        description="The costs to the patient for services under this network or formulary.",
    )
    offersPrescriptionByMail: Optional[Union[List[Union[StrictBool, Any, str]], StrictBool, Any, str]] = Field(
        default=None,
