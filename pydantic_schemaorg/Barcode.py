...
class Barcode(BaseModel):
    ...
    exifData: Optional[Union[List[Union[str, dynamic_creation('Text'), dynamic_creation('PropertyValue')]], str, dynamic_creation('Text'), dynamic_creation('PropertyValue')]] = Field(
        default=None,
    ...
    representativeOfPage: Optional[Union[List[Union[StrictBool, dynamic_creation('Boolean'), str]], StrictBool, dynamic_creation('Boolean'), str]] = Field(
        default=None,
