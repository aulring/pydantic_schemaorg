...
class MedicalCode(BaseModel):
    ...
    inDefinedTermSet: Optional[Union[List[Union[AnyUrl, dynamic_creation('URL'), dynamic_creation('DefinedTermSet'), str]], AnyUrl, dynamic_creation('URL'), dynamic_creation('DefinedTermSet'), str]] = Field(
        default=None,
        description="A [[DefinedTermSet]] that contains this term.",
    )
    termCode: Optional[Union[List[Union[str, dynamic_creation('Text')]], str, dynamic_creation('Text')]] = Field(
        default=None,
        description="A code that identifies this [[DefinedTerm]] within a [[DefinedTermSet]]",
    )
    codeValue: Optional[Union[List[Union[str, dynamic_creation('Text')]], str, dynamic_creation('Text')]] = Field(
        default=None,
        description="A short textual code that uniquely identifies the value.",
    )
    inCodeSet: Optional[Union[List[Union[AnyUrl, dynamic_creation('URL'), dynamic_creation('CategoryCodeSet'), str]], AnyUrl, dynamic_creation('URL'), dynamic_creation('CategoryCodeSet'), str]] = Field(
        default=None,
    ...
    codingSystem: Optional[Union[List[Union[str, dynamic_creation('Text')]], str, dynamic_creation('Text')]] = Field(
        default=None,
