...
class MedicalCode(BaseModel):
    ...
    inDefinedTermSet: Optional[Union[List[Union[Any, str, AnyUrl]], Any, str, AnyUrl]] = Field(
        default=None,
        description="A [[DefinedTermSet]] that contains this term.",
    )
    termCode: Union[List[Union[Any, str]], Any, str] = Field(
        default=None,
        description="A code that identifies this [[DefinedTerm]] within a [[DefinedTermSet]]",
    )
    codeValue: Union[List[Union[Any, str]], Any, str] = Field(
        default=None,
        description="A short textual code that uniquely identifies the value.",
    )
    inCodeSet: Optional[Union[List[Union[Any, str, AnyUrl]], Any, str, AnyUrl]] = Field(
        default=None,
    ...
    codingSystem: Union[List[Union[Any, str]], Any, str] = Field(
        default=None,
