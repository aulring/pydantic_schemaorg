...
class DrugCost(BaseModel):
    ...
    costPerUnit: Optional[Union[List[Union[StrictInt, StrictFloat, dynamic_creation('Number'), str, dynamic_creation('Text'), dynamic_creation('QualitativeValue')]], StrictInt, StrictFloat, dynamic_creation('Number'), str, dynamic_creation('Text'), dynamic_creation('QualitativeValue')]] = Field(
        default=None,
        description="The cost per unit of the drug.",
    )
    applicableLocation: Optional[Union[List[Union[dynamic_creation('AdministrativeArea'), str]], dynamic_creation('AdministrativeArea'), str]] = Field(
        default=None,
    ...
    costOrigin: Optional[Union[List[Union[str, dynamic_creation('Text')]], str, dynamic_creation('Text')]] = Field(
        default=None,
        description="Additional details to capture the origin of the cost data. For example, 'Medicare Part"
     "B'.",
    )
    costCategory: Optional[Union[List[Union[dynamic_creation('DrugCostCategory'), str]], dynamic_creation('DrugCostCategory'), str]] = Field(
        default=None,
        description="The category of cost, such as wholesale, retail, reimbursement cap, etc.",
    )
    costCurrency: Optional[Union[List[Union[str, dynamic_creation('Text')]], str, dynamic_creation('Text')]] = Field(
        default=None,
