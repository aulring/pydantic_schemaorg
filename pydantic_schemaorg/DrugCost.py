...
class DrugCost(BaseModel):
    ...
    costPerUnit: Union[List[Union[Any, StrictInt, StrictFloat, str]], Any, StrictInt, StrictFloat, str] = Field(
        default=None,
        description="The cost per unit of the drug.",
    )
    applicableLocation: Optional[Union[List[Union[Any, str]], Any, str]] = Field(
        default=None,
