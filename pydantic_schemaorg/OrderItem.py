...
class OrderItem(BaseModel):
    ...
    orderItemStatus: Optional[Union[List[Union[Any, str]], Any, str]] = Field(
        default=None,
        description="The current status of the order item.",
    )
    orderQuantity: Optional[Union[List[Union[Any, StrictInt, StrictFloat, str]], Any, StrictInt, StrictFloat, str]] = Field(
        default=None,
    ...
    orderItemNumber: Union[List[Union[Any, str]], Any, str] = Field(
        default=None,
