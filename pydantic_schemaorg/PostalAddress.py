...
class PostalAddress(BaseModel):
    ...
    productSupported: Union[List[Union[Any, str]], Any, str] = Field(
        default=None,
    ...
    contactOption: Optional[Union[List[Union[Any, str]], Any, str]] = Field(
        default=None,
    ...
    contactType: Union[List[Union[Any, str]], Any, str] = Field(
        default=None,
    ...
    addressLocality: Union[List[Union[Any, str]], Any, str] = Field(
        default=None,
        description="The locality in which the street address is, and which is in the region. For example, Mountain"
     "View.",
    )
    postOfficeBoxNumber: Union[List[Union[Any, str]], Any, str] = Field(
        default=None,
        description="The post office box number for PO box addresses.",
    )
    streetAddress: Union[List[Union[Any, str]], Any, str] = Field(
        default=None,
        description="The street address. For example, 1600 Amphitheatre Pkwy.",
    )
    addressCountry: Union[List[Union[Any, str]], Any, str] = Field(
        default=None,
    ...
    postalCode: Union[List[Union[Any, str]], Any, str] = Field(
        default=None,
        description="The postal code. For example, 94043.",
    )
    addressRegion: Union[List[Union[Any, str]], Any, str] = Field(
        default=None,
