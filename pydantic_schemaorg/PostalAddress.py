...
class PostalAddress(BaseModel):
    ...
    productSupported: Optional[Union[List[Union[str, dynamic_creation('Text'), dynamic_creation('Product')]], str, dynamic_creation('Text'), dynamic_creation('Product')]] = Field(
        default=None,
    ...
    contactOption: Optional[Union[List[Union[dynamic_creation('ContactPointOption'), str]], dynamic_creation('ContactPointOption'), str]] = Field(
        default=None,
    ...
    contactType: Optional[Union[List[Union[str, dynamic_creation('Text')]], str, dynamic_creation('Text')]] = Field(
        default=None,
    ...
    addressLocality: Optional[Union[List[Union[str, dynamic_creation('Text')]], str, dynamic_creation('Text')]] = Field(
        default=None,
        description="The locality in which the street address is, and which is in the region. For example, Mountain"
     "View.",
    )
    postOfficeBoxNumber: Optional[Union[List[Union[str, dynamic_creation('Text')]], str, dynamic_creation('Text')]] = Field(
        default=None,
        description="The post office box number for PO box addresses.",
    )
    streetAddress: Optional[Union[List[Union[str, dynamic_creation('Text')]], str, dynamic_creation('Text')]] = Field(
        default=None,
    ...
    addressRegion: Optional[Union[List[Union[str, dynamic_creation('Text')]], str, dynamic_creation('Text')]] = Field(
        default=None,
