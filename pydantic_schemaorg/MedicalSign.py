...
class MedicalSign(BaseModel):
    ...
    identifyingExam: Optional[Union[List[Union[dynamic_creation('PhysicalExam'), str]], dynamic_creation('PhysicalExam'), str]] = Field(
        default=None,
        description="A physical examination that can identify this sign.",
    )
    identifyingTest: Optional[Union[List[Union[dynamic_creation('MedicalTest'), str]], dynamic_creation('MedicalTest'), str]] = Field(
        default=None,
