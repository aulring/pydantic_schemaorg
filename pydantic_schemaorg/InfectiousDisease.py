...
class InfectiousDisease(BaseModel):
    ...
    infectiousAgent: Union[List[Union[Any, str]], Any, str] = Field(
        default=None,
        description="The actual infectious agent, such as a specific bacterium.",
    )
    infectiousAgentClass: Optional[Union[List[Union[Any, str]], Any, str]] = Field(
        default=None,
        description="The class of infectious agent (bacteria, prion, etc.) that causes the disease.",
    )
    transmissionMethod: Union[List[Union[Any, str]], Any, str] = Field(
        default=None,
