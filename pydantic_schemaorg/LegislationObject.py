...
class LegislationObject(BaseModel):
    ...
    legislationPassedBy: Optional[Union[List[Union[dynamic_creation('Organization'), dynamic_creation('Person'), str]], dynamic_creation('Organization'), dynamic_creation('Person'), str]] = Field(
        default=None,
    ...
    legislationDate: Optional[Union[List[Union[date, dynamic_creation('Date'), str]], date, dynamic_creation('Date'), str]] = Field(
        default=None,
    ...
    legislationIdentifier: Optional[Union[List[Union[AnyUrl, dynamic_creation('URL'), str, dynamic_creation('Text')]], AnyUrl, dynamic_creation('URL'), str, dynamic_creation('Text')]] = Field(
        default=None,
    ...
    legislationType: Optional[Union[List[Union[str, dynamic_creation('Text'), dynamic_creation('CategoryCode')]], str, dynamic_creation('Text'), dynamic_creation('CategoryCode')]] = Field(
        default=None,
    ...
    jurisdiction: Optional[Union[List[Union[str, dynamic_creation('Text'), dynamic_creation('AdministrativeArea')]], str, dynamic_creation('Text'), dynamic_creation('AdministrativeArea')]] = Field(
        default=None,
        description="Indicates a legal jurisdiction, e.g. of some legislation, or where some government"
     "service is based.",
    )
    legislationDateVersion: Optional[Union[List[Union[date, dynamic_creation('Date'), str]], date, dynamic_creation('Date'), str]] = Field(
        default=None,
    ...
    legislationLegalForce: Optional[Union[List[Union[dynamic_creation('LegalForceStatus'), str]], dynamic_creation('LegalForceStatus'), str]] = Field(
        default=None,
        description="Whether the legislation is currently in force, not in force, or partially in force.",
    )
    legislationResponsible: Optional[Union[List[Union[dynamic_creation('Organization'), dynamic_creation('Person'), str]], dynamic_creation('Organization'), dynamic_creation('Person'), str]] = Field(
        default=None,
    ...
    legislationJurisdiction: Optional[Union[List[Union[str, dynamic_creation('Text'), dynamic_creation('AdministrativeArea')]], str, dynamic_creation('Text'), dynamic_creation('AdministrativeArea')]] = Field(
        default=None,
    ...
    embedUrl: Optional[Union[List[Union[AnyUrl, dynamic_creation('URL'), str]], AnyUrl, dynamic_creation('URL'), str]] = Field(
        default=None,
    ...
    bitrate: Optional[Union[List[Union[str, dynamic_creation('Text')]], str, dynamic_creation('Text')]] = Field(
        default=None,
    ...
    sha256: Optional[Union[List[Union[str, dynamic_creation('Text')]], str, dynamic_creation('Text')]] = Field(
        default=None,
    ...
    contentSize: Optional[Union[List[Union[str, dynamic_creation('Text')]], str, dynamic_creation('Text')]] = Field(
        default=None,
    ...
    playerType: Optional[Union[List[Union[str, dynamic_creation('Text')]], str, dynamic_creation('Text')]] = Field(
        default=None,
        description="Player type required&#x2014;for example, Flash or Silverlight.",
    )
    associatedArticle: Optional[Union[List[Union[dynamic_creation('NewsArticle'), str]], dynamic_creation('NewsArticle'), str]] = Field(
        default=None,
    ...
    regionsAllowed: Optional[Union[List[Union[dynamic_creation('Place'), str]], dynamic_creation('Place'), str]] = Field(
        default=None,
    ...
    contentUrl: Optional[Union[List[Union[AnyUrl, dynamic_creation('URL'), str]], AnyUrl, dynamic_creation('URL'), str]] = Field(
        default=None,
        description="Actual bytes of the media object, for example the image file or video file.",
    )
    productionCompany: Optional[Union[List[Union[dynamic_creation('Organization'), str]], dynamic_creation('Organization'), str]] = Field(
        default=None,
        description="The production company or studio responsible for the item, e.g. series, video game,"
     "episode etc.",
    )
    encodesCreativeWork: Optional[Union[List[Union[dynamic_creation('CreativeWork'), str]], dynamic_creation('CreativeWork'), str]] = Field(
        default=None,
        description="The CreativeWork encoded by this media object.",
    )
    uploadDate: Optional[Union[List[Union[date, dynamic_creation('Date'), str]], date, dynamic_creation('Date'), str]] = Field(
        default=None,
    ...
    legislationLegalValue: Optional[Union[List[Union[dynamic_creation('LegalValueLevel'), str]], dynamic_creation('LegalValueLevel'), str]] = Field(
        default=None,
