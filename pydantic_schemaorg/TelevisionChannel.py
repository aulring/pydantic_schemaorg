...
class TelevisionChannel(BaseModel):
    ...
    broadcastChannelId: Union[List[Union[Any, str]], Any, str] = Field(
        default=None,
    ...
    providesBroadcastService: Optional[Union[List[Union[Any, str]], Any, str]] = Field(
        default=None,
    ...
    broadcastServiceTier: Union[List[Union[Any, str]], Any, str] = Field(
        default=None,
        description="The type of service required to have access to the channel (e.g. Standard or Premium).",
    )
    inBroadcastLineup: Optional[Union[List[Union[Any, str]], Any, str]] = Field(
        default=None,
