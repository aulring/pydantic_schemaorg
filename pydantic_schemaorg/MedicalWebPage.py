...
class MedicalWebPage(BaseModel):
    ...
    significantLink: Optional[Union[List[Union[Any, str, AnyUrl]], Any, str, AnyUrl]] = Field(
        default=None,
    ...
    mainContentOfPage: Optional[Union[List[Union[Any, str]], Any, str]] = Field(
        default=None,
    ...
    primaryImageOfPage: Optional[Union[List[Union[Any, str]], Any, str]] = Field(
        default=None,
        description="Indicates the main image on the page.",
    )
    medicalAudience: Optional[Union[List[Union[Any, str]], Any, str]] = Field(
        default=None,
        description="Medical audience for page.",
    )
    aspect: Union[List[Union[Any, str]], Any, str] = Field(
        default=None,
