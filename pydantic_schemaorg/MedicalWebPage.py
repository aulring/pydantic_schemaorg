...
class MedicalWebPage(BaseModel):
    ...
    significantLink: Optional[Union[List[Union[AnyUrl, dynamic_creation('URL'), str]], AnyUrl, dynamic_creation('URL'), str]] = Field(
        default=None,
    ...
    specialty: Optional[Union[List[Union[dynamic_creation('Specialty'), str]], dynamic_creation('Specialty'), str]] = Field(
        default=None,
        description="One of the domain specialities to which this web page's content applies.",
    )
    reviewedBy: Optional[Union[List[Union[dynamic_creation('Organization'), dynamic_creation('Person'), str]], dynamic_creation('Organization'), dynamic_creation('Person'), str]] = Field(
        default=None,
        description="People or organizations that have reviewed the content on this web page for accuracy"
     "and/or completeness.",
    )
    lastReviewed: Optional[Union[List[Union[date, dynamic_creation('Date'), str]], date, dynamic_creation('Date'), str]] = Field(
        default=None,
        description="Date on which the content on this web page was last reviewed for accuracy and/or completeness.",
    )
    relatedLink: Optional[Union[List[Union[AnyUrl, dynamic_creation('URL'), str]], AnyUrl, dynamic_creation('URL'), str]] = Field(
        default=None,
        description="A link related to this web page, for example to other related web pages.",
    )
    breadcrumb: Optional[Union[List[Union[str, dynamic_creation('Text'), dynamic_creation('BreadcrumbList')]], str, dynamic_creation('Text'), dynamic_creation('BreadcrumbList')]] = Field(
        default=None,
        description="A set of links that can help a user understand and navigate a website hierarchy.",
    )
    significantLinks: Optional[Union[List[Union[AnyUrl, dynamic_creation('URL'), str]], AnyUrl, dynamic_creation('URL'), str]] = Field(
        default=None,
    ...
    mainContentOfPage: Optional[Union[List[Union[dynamic_creation('WebPageElement'), str]], dynamic_creation('WebPageElement'), str]] = Field(
        default=None,
    ...
    primaryImageOfPage: Optional[Union[List[Union[dynamic_creation('ImageObject'), str]], dynamic_creation('ImageObject'), str]] = Field(
        default=None,
        description="Indicates the main image on the page.",
    )
    medicalAudience: Optional[Union[List[Union[dynamic_creation('MedicalAudience'), dynamic_creation('MedicalAudienceType'), str]], dynamic_creation('MedicalAudience'), dynamic_creation('MedicalAudienceType'), str]] = Field(
        default=None,
        description="Medical audience for page.",
    )
    aspect: Optional[Union[List[Union[str, dynamic_creation('Text')]], str, dynamic_creation('Text')]] = Field(
        default=None,
