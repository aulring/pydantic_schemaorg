...
class HealthInsurancePlan(BaseModel):
    ...
    benefitsSummaryUrl: Optional[Union[List[Union[Any, str, AnyUrl]], Any, str, AnyUrl]] = Field(
        default=None,
    ...
    healthPlanId: Union[List[Union[Any, str]], Any, str] = Field(
        default=None,
        description="The 14-character, HIOS-generated Plan ID number. (Plan IDs must be unique, even across"
     "different markets.)",
    )
    healthPlanMarketingUrl: Optional[Union[List[Union[Any, str, AnyUrl]], Any, str, AnyUrl]] = Field(
        default=None,
        description="The URL that goes directly to the plan brochure for the specific standard plan or plan"
     "variation.",
    )
    includesHealthPlanFormulary: Optional[Union[List[Union[Any, str]], Any, str]] = Field(
        default=None,
    ...
    healthPlanDrugTier: Union[List[Union[Any, str]], Any, str] = Field(
        default=None,
        description="The tier(s) of drugs offered by this formulary or insurance plan.",
    )
    healthPlanDrugOption: Union[List[Union[Any, str]], Any, str] = Field(
        default=None,
        description="TODO.",
    )
    includesHealthPlanNetwork: Optional[Union[List[Union[Any, str]], Any, str]] = Field(
        default=None,
        description="Networks covered by this plan.",
    )
    usesHealthPlanIdStandard: Union[List[Union[Any, str, AnyUrl]], Any, str, AnyUrl] = Field(
        default=None,
