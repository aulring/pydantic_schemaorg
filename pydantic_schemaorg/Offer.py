...
class Offer(BaseModel):
    ...
    itemOffered: Optional[Union[List[Union[Service, MenuItem, Trip, AggregateOffer, Event, Product, CreativeWork, str]], Service, MenuItem, Trip, AggregateOffer, Event, Product, CreativeWork, str]] = Field(
        default=None,
