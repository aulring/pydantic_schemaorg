...
class ShippingRateSettings(BaseModel):
    ...
    freeShippingThreshold: Optional[Union[List[Union[Any, str]], Any, str]] = Field(
        default=None,
    ...
    isUnlabelledFallback: Optional[Union[List[Union[StrictBool, Any, str]], StrictBool, Any, str]] = Field(
        default=None,
