...
class ShippingRateSettings(BaseModel):
    ...
    freeShippingThreshold: Optional[Union[List[Union[dynamic_creation('MonetaryAmount'), dynamic_creation('DeliveryChargeSpecification'), str]], dynamic_creation('MonetaryAmount'), dynamic_creation('DeliveryChargeSpecification'), str]] = Field(
        default=None,
    ...
    isUnlabelledFallback: Optional[Union[List[Union[StrictBool, dynamic_creation('Boolean'), str]], StrictBool, dynamic_creation('Boolean'), str]] = Field(
        default=None,
