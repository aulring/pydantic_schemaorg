...
class PostalCodeRangeSpecification(BaseModel):
    ...
    postalCodeBegin: Optional[Union[List[Union[str, dynamic_creation('Text')]], str, dynamic_creation('Text')]] = Field(
        default=None,
        description="First postal code in a range (included).",
    )
    postalCodeEnd: Optional[Union[List[Union[str, dynamic_creation('Text')]], str, dynamic_creation('Text')]] = Field(
        default=None,
