...
class AnatomicalSystem(BaseModel):
    ...
    comprisedOf: Optional[Union[List[Union[dynamic_creation('AnatomicalStructure'), Any, str]], dynamic_creation('AnatomicalStructure'), Any, str]] = Field(
        default=None,
    ...
    relatedStructure: Optional[Union[List[Union[dynamic_creation('AnatomicalStructure'), str]], dynamic_creation('AnatomicalStructure'), str]] = Field(
        default=None,
