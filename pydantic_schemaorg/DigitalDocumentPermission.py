...
class DigitalDocumentPermission(BaseModel):
    ...
    grantee: Optional[Union[List[Union[dynamic_creation('ContactPoint'), dynamic_creation('Organization'), dynamic_creation('Audience'), dynamic_creation('Person'), str]], dynamic_creation('ContactPoint'), dynamic_creation('Organization'), dynamic_creation('Audience'), dynamic_creation('Person'), str]] = Field(
        default=None,
        description="The person, organization, contact point, or audience that has been granted this permission.",
    )
    permissionType: Optional[Union[List[Union[dynamic_creation('DigitalDocumentPermissionType'), str]], dynamic_creation('DigitalDocumentPermissionType'), str]] = Field(
        default=None,
