...
class Taxon(BaseModel):
    ...
    parentTaxon: Union[List[Union[Any, str, AnyUrl]], Any, str, AnyUrl] = Field(
        default=None,
        description="Closest parent taxon of the taxon in question.",
    )
    taxonRank: Union[List[Union[Any, str, AnyUrl]], Any, str, AnyUrl] = Field(
        default=None,
    ...
    childTaxon: Union[List[Union[Any, str, AnyUrl]], Any, str, AnyUrl] = Field(
        default=None,
