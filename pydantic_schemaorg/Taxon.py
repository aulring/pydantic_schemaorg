...
class Taxon(BaseModel):
    ...
    parentTaxon: Union[List[Union[AnyUrl, dynamic_creation('URL'), str, dynamic_creation('Text'), Any]], AnyUrl, dynamic_creation('URL'), str, dynamic_creation('Text'), Any] = Field(
        default=None,
        description="Closest parent taxon of the taxon in question.",
    )
    taxonRank: Optional[Union[List[Union[AnyUrl, dynamic_creation('URL'), str, dynamic_creation('Text'), dynamic_creation('PropertyValue')]], AnyUrl, dynamic_creation('URL'), str, dynamic_creation('Text'), dynamic_creation('PropertyValue')]] = Field(
        default=None,
    ...
    childTaxon: Union[List[Union[AnyUrl, dynamic_creation('URL'), str, dynamic_creation('Text'), Any]], AnyUrl, dynamic_creation('URL'), str, dynamic_creation('Text'), Any] = Field(
        default=None,
        description="Closest child taxa of the taxon in question.",
    )
    hasDefinedTerm: Optional[Union[List[Union[dynamic_creation('DefinedTerm'), str]], dynamic_creation('DefinedTerm'), str]] = Field(
        default=None,
