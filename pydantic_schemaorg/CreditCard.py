...
class CreditCard(BaseModel):
    ...
    annualPercentageRate: Optional[Union[List[Union[StrictInt, StrictFloat, dynamic_creation('Number'), dynamic_creation('QuantitativeValue'), str]], StrictInt, StrictFloat, dynamic_creation('Number'), dynamic_creation('QuantitativeValue'), str]] = Field(
        default=None,
    ...
    interestRate: Optional[Union[List[Union[StrictInt, StrictFloat, dynamic_creation('Number'), dynamic_creation('QuantitativeValue'), str]], StrictInt, StrictFloat, dynamic_creation('Number'), dynamic_creation('QuantitativeValue'), str]] = Field(
        default=None,
    ...
    feesAndCommissionsSpecification: Optional[Union[List[Union[AnyUrl, dynamic_creation('URL'), str, dynamic_creation('Text')]], AnyUrl, dynamic_creation('URL'), str, dynamic_creation('Text')]] = Field(
        default=None,
    ...
    requiredCollateral: Optional[Union[List[Union[str, dynamic_creation('Text'), dynamic_creation('Thing')]], str, dynamic_creation('Text'), dynamic_creation('Thing')]] = Field(
        default=None,
    ...
    loanType: Optional[Union[List[Union[AnyUrl, dynamic_creation('URL'), str, dynamic_creation('Text')]], AnyUrl, dynamic_creation('URL'), str, dynamic_creation('Text')]] = Field(
        default=None,
    ...
    renegotiableLoan: Optional[Union[List[Union[StrictBool, dynamic_creation('Boolean'), str]], StrictBool, dynamic_creation('Boolean'), str]] = Field(
        default=None,
        description="Whether the terms for payment of interest can be renegotiated during the life of the loan.",
    )
    gracePeriod: Optional[Union[List[Union[dynamic_creation('Duration'), str]], dynamic_creation('Duration'), str]] = Field(
        default=None,
    ...
    loanTerm: Optional[Union[List[Union[dynamic_creation('QuantitativeValue'), str]], dynamic_creation('QuantitativeValue'), str]] = Field(
        default=None,
        description="The duration of the loan or credit agreement.",
    )
    amount: Optional[Union[List[Union[StrictInt, StrictFloat, dynamic_creation('Number'), dynamic_creation('MonetaryAmount'), str]], StrictInt, StrictFloat, dynamic_creation('Number'), dynamic_creation('MonetaryAmount'), str]] = Field(
        default=None,
        description="The amount of money.",
    )
    loanRepaymentForm: Optional[Union[List[Union[dynamic_creation('RepaymentSpecification'), str]], dynamic_creation('RepaymentSpecification'), str]] = Field(
        default=None,
    ...
    recourseLoan: Optional[Union[List[Union[StrictBool, dynamic_creation('Boolean'), str]], StrictBool, dynamic_creation('Boolean'), str]] = Field(
        default=None,
    ...
    floorLimit: Optional[Union[List[Union[dynamic_creation('MonetaryAmount'), str]], dynamic_creation('MonetaryAmount'), str]] = Field(
        default=None,
        description="A floor limit is the amount of money above which credit card transactions must be authorized.",
    )
    cashBack: Optional[Union[List[Union[StrictInt, StrictFloat, dynamic_creation('Number'), StrictBool, dynamic_creation('Boolean'), str]], StrictInt, StrictFloat, dynamic_creation('Number'), StrictBool, dynamic_creation('Boolean'), str]] = Field(
        default=None,
        description="A cardholder benefit that pays the cardholder a small percentage of their net expenditures.",
    )
    contactlessPayment: Optional[Union[List[Union[StrictBool, dynamic_creation('Boolean'), str]], StrictBool, dynamic_creation('Boolean'), str]] = Field(
        default=None,
    ...
    monthlyMinimumRepaymentAmount: Optional[Union[List[Union[StrictInt, StrictFloat, dynamic_creation('Number'), dynamic_creation('MonetaryAmount'), str]], StrictInt, StrictFloat, dynamic_creation('Number'), dynamic_creation('MonetaryAmount'), str]] = Field(
        default=None,
