...
class Claim(BaseModel):
    ...
    claimInterpreter: Optional[Union[List[Union[Any, str]], Any, str]] = Field(
        default=None,
    ...
    appearance: Optional[Union[List[Union[Any, str]], Any, str]] = Field(
        default=None,
        description="Indicates an occurrence of a [[Claim]] in some [[CreativeWork]].",
    )
    firstAppearance: Optional[Union[List[Union[Any, str]], Any, str]] = Field(
        default=None,
