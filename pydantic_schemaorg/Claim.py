...
class Claim(BaseModel):
    ...
    claimInterpreter: Optional[Union[List[Union[dynamic_creation('Organization'), dynamic_creation('Person'), str]], dynamic_creation('Organization'), dynamic_creation('Person'), str]] = Field(
        default=None,
    ...
    appearance: Optional[Union[List[Union[dynamic_creation('CreativeWork'), str]], dynamic_creation('CreativeWork'), str]] = Field(
        default=None,
        description="Indicates an occurrence of a [[Claim]] in some [[CreativeWork]].",
    )
    firstAppearance: Optional[Union[List[Union[dynamic_creation('CreativeWork'), str]], dynamic_creation('CreativeWork'), str]] = Field(
        default=None,
