...
class Menu(BaseModel):
    ...
    hasMenuSection: Optional[Union[List[Union[dynamic_creation('MenuSection'), str]], dynamic_creation('MenuSection'), str]] = Field(
        default=None,
        description="A subgrouping of the menu (by dishes, course, serving time period, etc.).",
    )
    hasMenuItem: Optional[Union[List[Union[dynamic_creation('MenuItem'), str]], dynamic_creation('MenuItem'), str]] = Field(
        default=None,
