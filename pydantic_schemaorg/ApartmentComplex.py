...
class ApartmentComplex(BaseModel):
    ...
    numberOfAvailableAccommodationUnits: Optional[Union[List[Union[Any, str]], Any, str]] = Field(
        default=None,
    ...
    numberOfAccommodationUnits: Optional[Union[List[Union[Any, str]], Any, str]] = Field(
        default=None,
