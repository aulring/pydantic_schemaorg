...
class ImagingTest(BaseModel):
    ...
    affectedBy: Optional[Union[List[Union[Any, str]], Any, str]] = Field(
        default=None,
        description="Drugs that affect the test's results.",
    )
    normalRange: Union[List[Union[Any, str]], Any, str] = Field(
        default=None,
        description="Range of acceptable values for a typical patient, when applicable.",
    )
    signDetected: Optional[Union[List[Union[Any, str]], Any, str]] = Field(
        default=None,
        description="A sign detected by the test.",
    )
    usedToDiagnose: Optional[Union[List[Union[Any, str]], Any, str]] = Field(
        default=None,
        description="A condition the test is used to diagnose.",
    )
    usesDevice: Optional[Union[List[Union[Any, str]], Any, str]] = Field(
        default=None,
        description="Device used to perform the test.",
    )
    imagingTechnique: Optional[Union[List[Union[Any, str]], Any, str]] = Field(
        default=None,
