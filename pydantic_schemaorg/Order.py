...
class Order(BaseModel):
    ...
    orderStatus: Optional[Union[List[Union[Any, str]], Any, str]] = Field(
        default=None,
        description="The current status of the order.",
    )
    isGift: Optional[Union[List[Union[StrictBool, Any, str]], StrictBool, Any, str]] = Field(
        default=None,
    ...
    discount: Union[List[Union[Any, StrictInt, StrictFloat, str]], Any, StrictInt, StrictFloat, str] = Field(
        default=None,
        description="Any discount applied (to an Order).",
    )
    discountCurrency: Union[List[Union[Any, str]], Any, str] = Field(
        default=None,
    ...
    acceptedOffer: Optional[Union[List[Union[Any, str]], Any, str]] = Field(
        default=None,
    ...
    merchant: Optional[Union[List[Union[Any, str]], Any, str]] = Field(
        default=None,
        description="'merchant' is an out-dated term for 'seller'.",
    )
    partOfInvoice: Optional[Union[List[Union[Any, str]], Any, str]] = Field(
        default=None,
        description="The order is being paid as part of the referenced Invoice.",
    )
    orderNumber: Union[List[Union[Any, str]], Any, str] = Field(
        default=None,
    ...
    discountCode: Union[List[Union[Any, str]], Any, str] = Field(
        default=None,
        description="Code used to redeem a discount.",
    )
    orderDelivery: Optional[Union[List[Union[Any, str]], Any, str]] = Field(
        default=None,
        description="The delivery of the parcel related to this order or order item.",
    )
    orderedItem: Optional[Union[List[Union[Any, str]], Any, str]] = Field(
        default=None,
        description="The item ordered.",
    )
    billingAddress: Optional[Union[List[Union[Any, str]], Any, str]] = Field(
        default=None,
        description="The billing address for the order.",
    )
    paymentUrl: Optional[Union[List[Union[Any, str, AnyUrl]], Any, str, AnyUrl]] = Field(
        default=None,
        description="The URL for sending a payment.",
    )
    orderDate: Optional[Union[List[Union[datetime, date, Any, str]], datetime, date, Any, str]] = Field(
        default=None,
