...
class Muscle(BaseModel):
    ...
    nerve: Optional[Union[List[Union[dynamic_creation('Nerve'), str]], dynamic_creation('Nerve'), str]] = Field(
        default=None,
        description="The underlying innervation associated with the muscle.",
    )
    muscleAction: Optional[Union[List[Union[str, dynamic_creation('Text')]], str, dynamic_creation('Text')]] = Field(
        default=None,
        description="The movement the muscle generates.",
    )
    bloodSupply: Optional[Union[List[Union[dynamic_creation('Vessel'), str]], dynamic_creation('Vessel'), str]] = Field(
        default=None,
        description="The blood vessel that carries blood from the heart to the muscle.",
    )
    antagonist: Optional[Union[List[Union[Any, str]], Any, str]] = Field(
        default=None,
        description="The muscle whose action counteracts the specified muscle.",
    )
    insertion: Optional[Union[List[Union[dynamic_creation('AnatomicalStructure'), str]], dynamic_creation('AnatomicalStructure'), str]] = Field(
        default=None,
