...
class Muscle(BaseModel):
    ...
    partOfSystem: Optional[Union[List[Union[Any, str]], Any, str]] = Field(
        default=None,
        description="The anatomical or organ system that this structure is part of.",
    )
    associatedPathophysiology: Union[List[Union[Any, str]], Any, str] = Field(
        default=None,
    ...
    relatedTherapy: Optional[Union[List[Union[Any, str]], Any, str]] = Field(
        default=None,
    ...
    relatedCondition: Optional[Union[List[Union[Any, str]], Any, str]] = Field(
        default=None,
        description="A medical condition associated with this anatomy.",
    )
    diagram: Optional[Union[List[Union[Any, str]], Any, str]] = Field(
        default=None,
    ...
    nerve: Optional[Union[List[Union[Any, str]], Any, str]] = Field(
        default=None,
        description="The underlying innervation associated with the muscle.",
    )
    muscleAction: Union[List[Union[Any, str]], Any, str] = Field(
        default=None,
        description="The movement the muscle generates.",
    )
    bloodSupply: Optional[Union[List[Union[Any, str]], Any, str]] = Field(
        default=None,
    ...
    insertion: Optional[Union[List[Union[Any, str]], Any, str]] = Field(
        default=None,
