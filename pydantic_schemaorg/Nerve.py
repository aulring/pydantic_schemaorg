...
class Nerve(BaseModel):
    ...
    connectedTo: Optional[Union[List[Union[Any, str]], Any, str]] = Field(
        default=None,
        description="Other anatomical structures to which this structure is connected.",
    )
    partOfSystem: Optional[Union[List[Union[dynamic_creation('AnatomicalSystem'), str]], dynamic_creation('AnatomicalSystem'), str]] = Field(
        default=None,
        description="The anatomical or organ system that this structure is part of.",
    )
    associatedPathophysiology: Optional[Union[List[Union[str, dynamic_creation('Text')]], str, dynamic_creation('Text')]] = Field(
        default=None,
    ...
    relatedTherapy: Optional[Union[List[Union[dynamic_creation('MedicalTherapy'), str]], dynamic_creation('MedicalTherapy'), str]] = Field(
        default=None,
        description="A medical therapy related to this anatomy.",
    )
    subStructure: Optional[Union[List[Union[Any, str]], Any, str]] = Field(
        default=None,
        description="Component (sub-)structure(s) that comprise this anatomical structure.",
    )
    relatedCondition: Optional[Union[List[Union[dynamic_creation('MedicalCondition'), str]], dynamic_creation('MedicalCondition'), str]] = Field(
        default=None,
        description="A medical condition associated with this anatomy.",
    )
    diagram: Optional[Union[List[Union[dynamic_creation('ImageObject'), str]], dynamic_creation('ImageObject'), str]] = Field(
        default=None,
    ...
    nerveMotor: Optional[Union[List[Union[dynamic_creation('Muscle'), str]], dynamic_creation('Muscle'), str]] = Field(
        default=None,
        description="The neurological pathway extension that involves muscle control.",
    )
    branch: Optional[Union[List[Union[dynamic_creation('AnatomicalStructure'), str]], dynamic_creation('AnatomicalStructure'), str]] = Field(
        default=None,
        description="The branches that delineate from the nerve bundle. Not to be confused with [[branchOf]].",
    )
    sourcedFrom: Optional[Union[List[Union[dynamic_creation('BrainStructure'), str]], dynamic_creation('BrainStructure'), str]] = Field(
        default=None,
        description="The neurological pathway that originates the neurons.",
    )
    sensoryUnit: Optional[Union[List[Union[dynamic_creation('AnatomicalStructure'), dynamic_creation('SuperficialAnatomy'), str]], dynamic_creation('AnatomicalStructure'), dynamic_creation('SuperficialAnatomy'), str]] = Field(
        default=None,
