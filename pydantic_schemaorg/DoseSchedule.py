...
class DoseSchedule(BaseModel):
    ...
    doseValue: Optional[Union[List[Union[StrictInt, StrictFloat, dynamic_creation('Number'), dynamic_creation('QualitativeValue'), str]], StrictInt, StrictFloat, dynamic_creation('Number'), dynamic_creation('QualitativeValue'), str]] = Field(
        default=None,
        description="The value of the dose, e.g. 500.",
    )
    doseUnit: Optional[Union[List[Union[str, dynamic_creation('Text')]], str, dynamic_creation('Text')]] = Field(
        default=None,
        description="The unit of the dose, e.g. 'mg'.",
    )
    frequency: Optional[Union[List[Union[str, dynamic_creation('Text')]], str, dynamic_creation('Text')]] = Field(
        default=None,
