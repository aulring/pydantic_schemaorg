...
class SpreadsheetDigitalDocument(BaseModel):
    ...
    hasDigitalDocumentPermission: Optional[Union[List[Union[dynamic_creation('DigitalDocumentPermission'), str]], dynamic_creation('DigitalDocumentPermission'), str]] = Field(
        default=None,
