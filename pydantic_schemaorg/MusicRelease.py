...
class MusicRelease(BaseModel):
    ...
    tracks: Optional[Union[List[Union[Any, str]], Any, str]] = Field(
        default=None,
        description="A music recording (track)&#x2014;usually a single song.",
    )
    track: Optional[Union[List[Union[Any, str]], Any, str]] = Field(
        default=None,
    ...
    numTracks: Optional[Union[List[Union[Any, int, str]], Any, int, str]] = Field(
        default=None,
        description="The number of tracks in this album or playlist.",
    )
    releaseOf: Optional[Union[List[Union[Any, str]], Any, str]] = Field(
        default=None,
        description="The album this is a release of.",
    )
    musicReleaseFormat: Optional[Union[List[Union[Any, str]], Any, str]] = Field(
        default=None,
    ...
    recordLabel: Optional[Union[List[Union[Any, str]], Any, str]] = Field(
        default=None,
        description="The label that issued the release.",
    )
    catalogNumber: Union[List[Union[Any, str]], Any, str] = Field(
        default=None,
        description="The catalog number for the release.",
    )
    creditedTo: Optional[Union[List[Union[Any, str]], Any, str]] = Field(
        default=None,
