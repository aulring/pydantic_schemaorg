...
class MusicRelease(BaseModel):
    ...
    tracks: Optional[Union[List[Union[dynamic_creation('MusicRecording'), str]], dynamic_creation('MusicRecording'), str]] = Field(
        default=None,
        description="A music recording (track)&#x2014;usually a single song.",
    )
    track: Optional[Union[List[Union[dynamic_creation('ItemList'), dynamic_creation('MusicRecording'), str]], dynamic_creation('ItemList'), dynamic_creation('MusicRecording'), str]] = Field(
        default=None,
    ...
    numTracks: Optional[Union[List[Union[int, dynamic_creation('Integer'), str]], int, dynamic_creation('Integer'), str]] = Field(
        default=None,
        description="The number of tracks in this album or playlist.",
    )
    releaseOf: Optional[Union[List[Union[dynamic_creation('MusicAlbum'), str]], dynamic_creation('MusicAlbum'), str]] = Field(
        default=None,
        description="The album this is a release of.",
    )
    musicReleaseFormat: Optional[Union[List[Union[dynamic_creation('MusicReleaseFormatType'), str]], dynamic_creation('MusicReleaseFormatType'), str]] = Field(
        default=None,
    ...
    recordLabel: Optional[Union[List[Union[dynamic_creation('Organization'), str]], dynamic_creation('Organization'), str]] = Field(
        default=None,
        description="The label that issued the release.",
    )
    catalogNumber: Optional[Union[List[Union[str, dynamic_creation('Text')]], str, dynamic_creation('Text')]] = Field(
        default=None,
        description="The catalog number for the release.",
    )
    creditedTo: Optional[Union[List[Union[dynamic_creation('Organization'), dynamic_creation('Person'), str]], dynamic_creation('Organization'), dynamic_creation('Person'), str]] = Field(
        default=None,
