...
class SportsEvent(BaseModel):
    ...
    competitor: Optional[Union[List[Union[dynamic_creation('SportsTeam'), dynamic_creation('Person'), str]], dynamic_creation('SportsTeam'), dynamic_creation('Person'), str]] = Field(
        default=None,
        description="A competitor in a sports event.",
    )
    awayTeam: Optional[Union[List[Union[dynamic_creation('SportsTeam'), dynamic_creation('Person'), str]], dynamic_creation('SportsTeam'), dynamic_creation('Person'), str]] = Field(
        default=None,
        description="The away team in a sports event.",
    )
    sport: Optional[Union[List[Union[AnyUrl, dynamic_creation('URL'), str, dynamic_creation('Text')]], AnyUrl, dynamic_creation('URL'), str, dynamic_creation('Text')]] = Field(
        default=None,
        description="A type of sport (e.g. Baseball).",
    )
    homeTeam: Optional[Union[List[Union[dynamic_creation('SportsTeam'), dynamic_creation('Person'), str]], dynamic_creation('SportsTeam'), dynamic_creation('Person'), str]] = Field(
        default=None,
