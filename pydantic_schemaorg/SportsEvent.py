...
class SportsEvent(BaseModel):
    ...
    competitor: Optional[Union[List[Union[Any, str]], Any, str]] = Field(
        default=None,
        description="A competitor in a sports event.",
    )
    awayTeam: Optional[Union[List[Union[Any, str]], Any, str]] = Field(
        default=None,
    ...
    homeTeam: Optional[Union[List[Union[Any, str]], Any, str]] = Field(
        default=None,
