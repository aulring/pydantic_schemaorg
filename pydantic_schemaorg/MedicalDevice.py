...
class MedicalDevice(BaseModel):
    ...
    postOp: Optional[Union[List[Union[str, dynamic_creation('Text')]], str, dynamic_creation('Text')]] = Field(
        default=None,
        description="A description of the postoperative procedures, care, and/or followups for this device.",
    )
    seriousAdverseOutcome: Optional[Union[List[Union[dynamic_creation('MedicalEntity'), str]], dynamic_creation('MedicalEntity'), str]] = Field(
        default=None,
    ...
    preOp: Optional[Union[List[Union[str, dynamic_creation('Text')]], str, dynamic_creation('Text')]] = Field(
        default=None,
        description="A description of the workup, testing, and other preparations required before implanting"
     "this device.",
    )
    adverseOutcome: Optional[Union[List[Union[dynamic_creation('MedicalEntity'), str]], dynamic_creation('MedicalEntity'), str]] = Field(
        default=None,
    ...
    procedure: Optional[Union[List[Union[str, dynamic_creation('Text')]], str, dynamic_creation('Text')]] = Field(
        default=None,
        description="A description of the procedure involved in setting up, using, and/or installing the"
     "device.",
    )
    contraindication: Optional[Union[List[Union[str, dynamic_creation('Text'), dynamic_creation('MedicalContraindication')]], str, dynamic_creation('Text'), dynamic_creation('MedicalContraindication')]] = Field(
        default=None,
