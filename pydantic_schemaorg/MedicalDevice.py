...
class MedicalDevice(BaseModel):
    ...
    postOp: Union[List[Union[Any, str]], Any, str] = Field(
        default=None,
        description="A description of the postoperative procedures, care, and/or followups for this device.",
    )
    seriousAdverseOutcome: Optional[Union[List[Union[Any, str]], Any, str]] = Field(
        default=None,
    ...
    preOp: Union[List[Union[Any, str]], Any, str] = Field(
        default=None,
    ...
    procedure: Union[List[Union[Any, str]], Any, str] = Field(
        default=None,
        description="A description of the procedure involved in setting up, using, and/or installing the"
     "device.",
    )
    contraindication: Union[List[Union[Any, str]], Any, str] = Field(
        default=None,
