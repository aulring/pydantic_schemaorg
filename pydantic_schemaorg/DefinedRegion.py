...
class DefinedRegion(BaseModel):
    ...
    postalCodePrefix: Optional[Union[List[Union[str, dynamic_creation('Text')]], str, dynamic_creation('Text')]] = Field(
        default=None,
    ...
    postalCodeRange: Optional[Union[List[Union[dynamic_creation('PostalCodeRangeSpecification'), str]], dynamic_creation('PostalCodeRangeSpecification'), str]] = Field(
        default=None,
