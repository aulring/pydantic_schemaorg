...
class ExerciseAction(BaseModel):
    ...
    toLocation: Optional[Union[List[Union[dynamic_creation('Place'), str]], dynamic_creation('Place'), str]] = Field(
        default=None,
        description="A sub property of location. The final location of the object or the agent after the action.",
    )
    course: Optional[Union[List[Union[dynamic_creation('Place'), str]], dynamic_creation('Place'), str]] = Field(
        default=None,
        description="A sub property of location. The course where this action was taken.",
    )
    fromLocation: Optional[Union[List[Union[dynamic_creation('Place'), str]], dynamic_creation('Place'), str]] = Field(
        default=None,
        description="A sub property of location. The original location of the object or the agent before the"
     "action.",
    )
    exerciseRelatedDiet: Optional[Union[List[Union[dynamic_creation('Diet'), str]], dynamic_creation('Diet'), str]] = Field(
        default=None,
        description="A sub property of instrument. The diet used in this action.",
    )
    exerciseCourse: Optional[Union[List[Union[dynamic_creation('Place'), str]], dynamic_creation('Place'), str]] = Field(
        default=None,
        description="A sub property of location. The course where this action was taken.",
    )
    opponent: Optional[Union[List[Union[dynamic_creation('Person'), str]], dynamic_creation('Person'), str]] = Field(
        default=None,
        description="A sub property of participant. The opponent on this action.",
    )
    sportsTeam: Optional[Union[List[Union[dynamic_creation('SportsTeam'), str]], dynamic_creation('SportsTeam'), str]] = Field(
        default=None,
        description="A sub property of participant. The sports team that participated on this action.",
    )
    sportsEvent: Optional[Union[List[Union[dynamic_creation('SportsEvent'), str]], dynamic_creation('SportsEvent'), str]] = Field(
        default=None,
        description="A sub property of location. The sports event where this action occurred.",
    )
    diet: Optional[Union[List[Union[dynamic_creation('Diet'), str]], dynamic_creation('Diet'), str]] = Field(
        default=None,
        description="A sub property of instrument. The diet used in this action.",
    )
    exercisePlan: Optional[Union[List[Union[dynamic_creation('ExercisePlan'), str]], dynamic_creation('ExercisePlan'), str]] = Field(
        default=None,
        description="A sub property of instrument. The exercise plan used on this action.",
    )
    exerciseType: Optional[Union[List[Union[str, dynamic_creation('Text')]], str, dynamic_creation('Text')]] = Field(
        default=None,
    ...
    distance: Optional[Union[List[Union[dynamic_creation('Distance'), str]], dynamic_creation('Distance'), str]] = Field(
        default=None,
        description="The distance travelled, e.g. exercising or travelling.",
    )
    sportsActivityLocation: Optional[Union[List[Union[dynamic_creation('SportsActivityLocation'), str]], dynamic_creation('SportsActivityLocation'), str]] = Field(
        default=None,
