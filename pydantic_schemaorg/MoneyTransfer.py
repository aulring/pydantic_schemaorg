...
class MoneyTransfer(BaseModel):
    ...
    beneficiaryBank: Optional[Union[List[Union[str, dynamic_creation('Text'), dynamic_creation('BankOrCreditUnion')]], str, dynamic_creation('Text'), dynamic_creation('BankOrCreditUnion')]] = Field(
        default=None,
