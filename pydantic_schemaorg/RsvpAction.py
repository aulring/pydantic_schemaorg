...
class RsvpAction(BaseModel):
    ...
    language: Optional[Union[List[Union[Any, str]], Any, str]] = Field(
        default=None,
    ...
    additionalNumberOfGuests: Optional[Union[List[Union[Any, StrictInt, StrictFloat, str]], Any, StrictInt, StrictFloat, str]] = Field(
        default=None,
    ...
    rsvpResponse: Optional[Union[List[Union[Any, str]], Any, str]] = Field(
        default=None,
