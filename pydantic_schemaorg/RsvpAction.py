...
class RsvpAction(BaseModel):
    ...
    language: Optional[Union[List[Union[dynamic_creation('Language'), str]], dynamic_creation('Language'), str]] = Field(
        default=None,
    ...
    additionalNumberOfGuests: Optional[Union[List[Union[StrictInt, StrictFloat, dynamic_creation('Number'), str]], StrictInt, StrictFloat, dynamic_creation('Number'), str]] = Field(
        default=None,
    ...
    rsvpResponse: Optional[Union[List[Union[dynamic_creation('RsvpResponseType'), str]], dynamic_creation('RsvpResponseType'), str]] = Field(
        default=None,
