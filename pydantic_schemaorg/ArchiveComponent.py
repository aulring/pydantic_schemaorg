...
class ArchiveComponent(BaseModel):
    ...
    holdingArchive: Optional[Union[List[Union[dynamic_creation('ArchiveOrganization'), str]], dynamic_creation('ArchiveOrganization'), str]] = Field(
        default=None,
        description="[[ArchiveOrganization]] that holds, keeps or maintains the [[ArchiveComponent]].",
    )
    itemLocation: Optional[Union[List[Union[str, dynamic_creation('Text'), dynamic_creation('PostalAddress'), dynamic_creation('Place')]], str, dynamic_creation('Text'), dynamic_creation('PostalAddress'), dynamic_creation('Place')]] = Field(
        default=None,
