...
class CourseInstance(BaseModel):
    ...
    courseWorkload: Union[List[Union[Any, str]], Any, str] = Field(
        default=None,
    ...
    courseMode: Union[List[Union[Any, str, AnyUrl]], Any, str, AnyUrl] = Field(
        default=None,
    ...
    instructor: Optional[Union[List[Union[Any, str]], Any, str]] = Field(
        default=None,
