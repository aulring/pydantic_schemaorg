...
class RentalCarReservation(BaseModel):
    ...
    pickupTime: Optional[Union[List[Union[datetime, Any, str]], datetime, Any, str]] = Field(
        default=None,
        description="When a taxi will pick up a passenger or a rental car can be picked up.",
    )
    pickupLocation: Optional[Union[List[Union[Any, str]], Any, str]] = Field(
        default=None,
        description="Where a taxi will pick up a passenger or a rental car can be picked up.",
    )
    dropoffLocation: Optional[Union[List[Union[Any, str]], Any, str]] = Field(
        default=None,
        description="Where a rental car can be dropped off.",
    )
    dropoffTime: Optional[Union[List[Union[datetime, Any, str]], datetime, Any, str]] = Field(
        default=None,
