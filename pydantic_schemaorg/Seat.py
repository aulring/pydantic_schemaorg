...
class Seat(BaseModel):
    ...
    seatSection: Union[List[Union[Any, str]], Any, str] = Field(
        default=None,
        description="The section location of the reserved seat (e.g. Orchestra).",
    )
    seatNumber: Union[List[Union[Any, str]], Any, str] = Field(
        default=None,
        description="The location of the reserved seat (e.g., 27).",
    )
    seatingType: Union[List[Union[Any, str]], Any, str] = Field(
        default=None,
        description="The type/class of the seat.",
    )
    seatRow: Union[List[Union[Any, str]], Any, str] = Field(
        default=None,
