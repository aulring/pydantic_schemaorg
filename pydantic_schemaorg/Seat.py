...
class Seat(BaseModel):
    ...
    seatSection: Optional[Union[List[Union[str, dynamic_creation('Text')]], str, dynamic_creation('Text')]] = Field(
        default=None,
        description="The section location of the reserved seat (e.g. Orchestra).",
    )
    seatNumber: Optional[Union[List[Union[str, dynamic_creation('Text')]], str, dynamic_creation('Text')]] = Field(
        default=None,
        description="The location of the reserved seat (e.g., 27).",
    )
    seatingType: Optional[Union[List[Union[str, dynamic_creation('Text'), dynamic_creation('QualitativeValue')]], str, dynamic_creation('Text'), dynamic_creation('QualitativeValue')]] = Field(
        default=None,
        description="The type/class of the seat.",
    )
    seatRow: Optional[Union[List[Union[str, dynamic_creation('Text')]], str, dynamic_creation('Text')]] = Field(
        default=None,
