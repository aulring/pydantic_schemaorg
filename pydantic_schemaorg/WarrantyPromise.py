...
class WarrantyPromise(BaseModel):
    ...
    warrantyScope: Optional[Union[List[Union[dynamic_creation('WarrantyScope'), str]], dynamic_creation('WarrantyScope'), str]] = Field(
        default=None,
        description="The scope of the warranty promise.",
    )
    durationOfWarranty: Optional[Union[List[Union[dynamic_creation('QuantitativeValue'), str]], dynamic_creation('QuantitativeValue'), str]] = Field(
        default=None,
