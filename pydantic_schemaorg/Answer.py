...
class Answer(BaseModel):
    ...
    answerExplanation: Optional[Union[List[Union[dynamic_creation('WebContent'), dynamic_creation('Comment'), str]], dynamic_creation('WebContent'), dynamic_creation('Comment'), str]] = Field(
        default=None,
