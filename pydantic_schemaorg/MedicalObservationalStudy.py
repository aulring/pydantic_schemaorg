...
class MedicalObservationalStudy(BaseModel):
    ...
    studySubject: Optional[Union[List[Union[dynamic_creation('MedicalEntity'), str]], dynamic_creation('MedicalEntity'), str]] = Field(
        default=None,
    ...
    studyLocation: Optional[Union[List[Union[dynamic_creation('AdministrativeArea'), str]], dynamic_creation('AdministrativeArea'), str]] = Field(
        default=None,
    ...
    studyDesign: Optional[Union[List[Union[dynamic_creation('MedicalObservationalStudyDesign'), str]], dynamic_creation('MedicalObservationalStudyDesign'), str]] = Field(
        default=None,
