...
class MusicGroup(BaseModel):
    ...
    album: Optional[Union[List[Union[dynamic_creation('MusicAlbum'), str]], dynamic_creation('MusicAlbum'), str]] = Field(
        default=None,
    ...
    albums: Optional[Union[List[Union[dynamic_creation('MusicAlbum'), str]], dynamic_creation('MusicAlbum'), str]] = Field(
        default=None,
    ...
    musicGroupMember: Optional[Union[List[Union[dynamic_creation('Person'), str]], dynamic_creation('Person'), str]] = Field(
        default=None,
