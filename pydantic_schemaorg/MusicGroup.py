...
class MusicGroup(BaseModel):
    ...
    album: Optional[Union[List[Union[Any, str]], Any, str]] = Field(
        default=None,
    ...
    albums: Optional[Union[List[Union[Any, str]], Any, str]] = Field(
        default=None,
    ...
    musicGroupMember: Optional[Union[List[Union[Any, str]], Any, str]] = Field(
        default=None,
