...
class StatisticalPopulation(BaseModel):
    ...
    constrainingProperty: Optional[Union[List[Union[Any, int, str]], Any, int, str]] = Field(
        default=None,
    ...
    populationType: Optional[Union[List[Union[Any, str]], Any, str]] = Field(
        default=None,
        description="Indicates the populationType common to all members of a [[StatisticalPopulation]].",
    )
    numConstraints: Optional[Union[List[Union[Any, int, str]], Any, int, str]] = Field(
        default=None,
