...
class MusicAlbum(BaseModel):
    ...
    albumReleaseType: Optional[Union[List[Union[dynamic_creation('MusicAlbumReleaseType'), str]], dynamic_creation('MusicAlbumReleaseType'), str]] = Field(
        default=None,
        description="The kind of release which this album is: single, EP or album.",
    )
    albumRelease: Optional[Union[List[Union[dynamic_creation('MusicRelease'), str]], dynamic_creation('MusicRelease'), str]] = Field(
        default=None,
        description="A release of this album.",
    )
    byArtist: Optional[Union[List[Union[dynamic_creation('MusicGroup'), dynamic_creation('Person'), str]], dynamic_creation('MusicGroup'), dynamic_creation('Person'), str]] = Field(
        default=None,
        description="The artist that performed this album or recording.",
    )
    albumProductionType: Optional[Union[List[Union[dynamic_creation('MusicAlbumProductionType'), str]], dynamic_creation('MusicAlbumProductionType'), str]] = Field(
        default=None,
