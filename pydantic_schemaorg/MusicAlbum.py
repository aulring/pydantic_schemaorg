...
class MusicAlbum(BaseModel):
    ...
    albumReleaseType: Optional[Union[List[Union[Any, str]], Any, str]] = Field(
        default=None,
        description="The kind of release which this album is: single, EP or album.",
    )
    albumRelease: Optional[Union[List[Union[Any, str]], Any, str]] = Field(
        default=None,
        description="A release of this album.",
    )
    byArtist: Optional[Union[List[Union[Any, str]], Any, str]] = Field(
        default=None,
        description="The artist that performed this album or recording.",
    )
    albumProductionType: Optional[Union[List[Union[Any, str]], Any, str]] = Field(
        default=None,
