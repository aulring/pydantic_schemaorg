...
class Artery(BaseModel):
    ...
    arterialBranch: Optional[Union[List[Union[dynamic_creation('AnatomicalStructure'), str]], dynamic_creation('AnatomicalStructure'), str]] = Field(
        default=None,
        description="The branches that comprise the arterial structure.",
    )
    supplyTo: Optional[Union[List[Union[dynamic_creation('AnatomicalStructure'), str]], dynamic_creation('AnatomicalStructure'), str]] = Field(
        default=None,
