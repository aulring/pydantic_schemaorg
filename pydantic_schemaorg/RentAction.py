...
class RentAction(BaseModel):
    ...
    realEstateAgent: Optional[Union[List[Union[dynamic_creation('RealEstateAgent'), str]], dynamic_creation('RealEstateAgent'), str]] = Field(
        default=None,
        description="A sub property of participant. The real estate agent involved in the action.",
    )
    landlord: Optional[Union[List[Union[dynamic_creation('Organization'), dynamic_creation('Person'), str]], dynamic_creation('Organization'), dynamic_creation('Person'), str]] = Field(
        default=None,
